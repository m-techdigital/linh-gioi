...
def main() -> int:
    require(
        ...
        'CreateBillboardSprite("LGO Gate Keeper Objective Pulse Sprite V3B", gateGuideSprite, GateKeeperPosition + Vector3.up * 0.1f, new Vector3(1.08f, 1.08f, 1f), 4)',
        'gateGuidePulse.color = new Color(RuntimeArtCatalog.Gold.r, RuntimeArtCatalog.Gold.g, RuntimeArtCatalog.Gold.b, 0.90f)',
