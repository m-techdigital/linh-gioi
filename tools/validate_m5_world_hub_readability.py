...
def main() -> int:
    require(
        ...
        'Spirit Gate south / Gate Keeper northwest / Training Stone north / Shadow Slime east',
    )
    require(
        'client/Unity/Assets/Game/UI/Runtime/M4PlayableClientController.cs',
        'Direction: ',
        'Landmarks: Spirit Gate south / Gate Keeper northwest / Training Stone north / Shadow Slime east.',
