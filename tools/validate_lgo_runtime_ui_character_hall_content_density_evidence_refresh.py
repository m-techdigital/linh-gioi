...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-CHARACTER-HALL-CONTENT-DENSITY-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_CHARACTER_HALL_CONTENT_DENSITY_EVIDENCE_REFRESH_READY",
        "character-lobby.png",
    ...
    require(
        ...
        "runtime_ui_character_hall_content_density_evidence_refresh",
        "validate_lgo_runtime_ui_character_hall_content_density_evidence_refresh.py",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI CHARACTER HALL CONTENT DENSITY EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_CHARACTER_HALL_CONTENT_DENSITY_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
