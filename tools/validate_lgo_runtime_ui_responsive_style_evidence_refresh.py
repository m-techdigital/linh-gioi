...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-RESPONSIVE-STYLE-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_RESPONSIVE_STYLE_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_responsive_style_evidence_refresh",
        "validate_lgo_runtime_ui_responsive_style_evidence_refresh.py",
    )
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI RESPONSIVE STYLE EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_RESPONSIVE_STYLE_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
