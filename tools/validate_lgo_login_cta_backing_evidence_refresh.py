...
def main() -> int:
    require(
        "docs/tasks/LGO-LOGIN-CTA-BACKING-EVIDENCE-REFRESH-v1.0.md",
        "LGO_LOGIN_CTA_BACKING_EVIDENCE_REFRESH_READY",
        "desktop/login.png",
        "tablet/login.png",
        "mobile/login.png",
    ...
    require(
        ...
        "login_cta_backing_evidence_refresh",
        "validate_lgo_login_cta_backing_evidence_refresh.py",
    )
    require(
        "docs/execution/NEXT-ACTION.md",
        "LGO-LOGIN-CTA-BACKING-EVIDENCE-REFRESH-v1.0",
        "LGO_LOGIN_CTA_BACKING_EVIDENCE_REFRESH_READY",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO LOGIN CTA BACKING EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_LOGIN_CTA_BACKING_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
