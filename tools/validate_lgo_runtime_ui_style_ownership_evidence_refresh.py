...
def check_manifest() -> None:
    ...
    for name in ["login.png", "world-hub.png", "session-menu.png", "target-dummy-state.png"]:
...
def main() -> int:
    ...
    check_manifest()
    require(
        "docs/tasks/LGO-RUNTIME-UI-STYLE-OWNERSHIP-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_STYLE_OWNERSHIP_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_style_ownership_evidence_refresh",
        "validate_lgo_runtime_ui_style_ownership_evidence_refresh.py",
    )
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI STYLE OWNERSHIP EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_STYLE_OWNERSHIP_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
