...
def main() -> int:
    require('docs/art/LGO-ART-DIRECTION-PACK-v0.20.0.md', 'LGO_ART_DIRECTION_PACK_ACCEPTED_v0.20.0', 'Hero pose sheet feeds v0.21')
    require(
        'client/Unity/Assets/Game/World/Runtime/PlayableWorldController.cs',
        'PlaceholderPoseState',
        'Idle',
        'WalkMove',
        'Interact',
        'SpiritChannel',
    ...
    require(
        ...
        'validate_m5_pose_animation_placeholder.py',
        'm5_pose_animation_placeholder',
    )
    require('docs/tasks/M5-POSE-ANIMATION-PLACEHOLDER-v0.21.0.md', 'M5_POSE_ANIMATION_PLACEHOLDER_SOURCE_READY_v0.21.0', 'not production animation')
    ...
    if errors:
        print('M5 POSE ANIMATION PLACEHOLDER VALIDATION FAILED', file=sys.stderr)
        for error in errors:
            print(' - ' + error, file=sys.stderr)
        return 1
    print('M5 POSE ANIMATION PLACEHOLDER VALIDATION PASS')
    return 0
