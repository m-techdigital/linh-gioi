...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-LABEL-FONT-METRICS-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_LABEL_FONT_METRICS_EVIDENCE_REFRESH_READY",
        "login.png",
    ...
    require(
        ...
        "runtime_ui_label_font_metrics_evidence_refresh",
        "validate_lgo_runtime_ui_label_font_metrics_evidence_refresh.py",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI LABEL FONT METRICS EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_LABEL_FONT_METRICS_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
