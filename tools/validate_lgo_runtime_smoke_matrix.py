...
def check_list_output() -> None:
    ...
    for marker in ("two_d_onboarding_smoke", "two_d_player_build", "two_d_visual_capture", "runtimeCongDongLamMap01AContractSnapshot", "CongDongLamMap01A", "mapId=map-01a-cong-dong-lam", "zones=10", "layers=12", "enemy-spawn=combat-edge-only", "runtimeMapSnapshot", "WorldMapNetwork", "LinhThanhHubRuntime", "HubShell", "district=plaza", "district=academy", "PlazaShell", "AcademyShell", "MarketShell", "SpiritTempleShell", "ResidentialShell", "ForgeShell", "GuildShell", "HarborShell", "safe-no-trade-backend", "safe-no-skill-backend", "safe-no-economy-backend", "safe-no-buff-backend", "safe-no-housing-backend", "safe-no-crafting-backend", "safe-no-guild-backend", "safe-no-travel-backend", "runtimeLinhThanhUnlockSnapshot", "LinhThanhUnlock", "unlock=plaza", "runtimeLinhThanhPlazaHubSnapshot", "PlazaHubRuntime", "runtimeLinhThanhAcademyShellSnapshot",
        ...
        "controls=P select, E interact", "runtimeTilemapSnapshot", "ChunkFlow", "runtimeDongMonTilePaletteSnapshot", "DongMonTilePalette", "tile_dash_lane:spirit-cyan:wind-streak", "runtimeDongMonTilePaletteSourceSnapshot", "DongMonTilePaletteSource", "resource=LGOMaps/DongMonTilePalette", "runtimeDongMonAuthoredDetailSourceSnapshot", "DongMonAuthoredDetailSource", "resource=LGOMaps/DongMonAuthoredDetails", "details=7", "authored-detail=True", "runtimeDongMonNpcSpriteSourceSnapshot", "DongMonNpcSpriteSource", "resource=LGOMaps/DongMonNpcSprites", "gate_keeper_parts=13", "authored-npc-sprite=True", "runtimeDongMonInteractionMarkerSourceSnapshot", "DongMonInteractionMarkerSource", "resource=LGOMaps/DongMonInteractionMarkers", "markers=5", "route=gatekeeper,training-stone,jump,dash,shadow-slime", "runtimeDongMonPlayerSceneFitSnapshot", "DongMonPlayerSceneFit", "footAnchor=bottom-center", "DongMonPlayerGroundingSource", "authored-player-grounding=True", "routeAnchor=shadow-slime lane=combat-lane y=-1.16 sortBand=combat-front", "visitedGrounding=shadow-slime lane=combat-lane playerSort=6 shadowSort=5", "safe-runtime-player-evidence=True", "runtimeVoLv1ClassSliceSnapshot", "VoLv1ClassSlice", "resource=LGOClasses/VoLv1ClassSlice", "classId=vo", "slots=5", "ClassSkill:vo_lv1_first_skill", "top=top_vo_lv1_male", "runtimeSkillCue=True", "compat=base_male_torso->OuterShirt", "anchorSet=Chest,Hips,Hand_L,Hand_R,Foot_L,Foot_R", "source=runtime-authored-json", "runtimeArtPolicy=replace-primitive-with-approved-spritesheet", "selectedCompat=True", "selectedSlot=OuterShirt", "selectedAnchor=Chest", "fitProfile=base_male_torso", "source=runtime-authored-catalog", "runtimeVoLv1PaperDollAtlasSnapshot", "VoLv1PaperDollAtlas", "resource=LGOClasses/VoLv1PaperDollAtlas", "slot=OuterShirt", "anchor=Chest", "skillCue=vo_lv1_first_skill_trail", "cellSource=runtime-generated-atlas-cell", "part=chest_panel cell=torso_outer_vo_lv1", "part=hand_wrap_r cell=glove_r_vo_lv1", "skillCue=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedRuntimeArt=True", "VoLv1ApprovedRuntimeArt", "levelBand=1-30", "cells=13", "approvedCell=chest_panel cell=torso_outer_vo_lv1", "approvedCell=inner_shadow cell=base_torso_male", "approvedCell=pants_shadow_l cell=pants_vo_lv1", "approvedCell=pants_shadow_r cell=pants_vo_lv1", "approvedCell=hand_wrap_r cell=glove_r_vo_lv1", "approvedCell=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedCell=vo_lv1_first_skill_edge cell=skill_vo_lv1_palm_trail", "approvedCell=vo_lv1_first_skill_impact cell=skill_vo_lv1_palm_burst",
            "approvedCell=sash_red_core cell=waist_vo_lv1",
            "approvedCell=weapon_staff cell=staff_vo_lv1", "productionAtlas=vo-lv1-starter-atlas-v1", "importMode=layered-psb-or-spritesheet", "texturePolicy=approved-original-2d-art-only", "requiredCell=torso_outer_vo_lv1", "requiredCell=skill_vo_lv1_palm_burst", "rigJoint=Hand_R", "motionClip=vo_lv1_first_skill", "replacementGate=preserve-runtime-fit-contract", "poseOffsets=", "pose=vo_jump_lift", "pose=vo_dash_stretch", "currentPose=vo_lv1_training_complete", "active=True", "pose=vo_lv1_training_complete", "safe-runtime-motion=True", "runtimeVoLv1AnchorGizmoSnapshot", "VoLv1AnchorGizmo", "visible=True", "slot=OuterShirt anchor=Chest", "slot=Gloves anchor=Hand_R", "slot=Boots anchor=Foot_L", "pivotPolicy=bottom-center-foot-anchor", "visibleWhen=inventory-or-class-training", "safe-runtime-gizmo=True", "runtimeVoLv1LevelBandFunctionProbeSnapshot", "VoLv1LevelBandFunctionProbe", "levelBand=1-30", "highTier31Plus=False", "paperDollSlots=OuterShirt,PantsOrSkirt,Waist,Gloves,Boots,Weapon", "tryOn=True", "applyEquipment=True", "motionStates=Idle,Jump,Dash,ClassSkill,TrainingCompletePose", "skill=vo_lv1_first_skill target=shadow-slime", "grounding=visited-shadow-slime", "runtimeVoLv1RuntimeFitSnapshot", "VoLv1RuntimeFit", "fitStatus=ANCHOR_ALIGNED", "slot=OuterShirt item=top_vo_lv1_male anchor=Chest pivot=bottom-center", "slot=Gloves item=gloves_vo_lv1_unisex anchor=Hand_R", "slot=Boots item=boots_vo_lv1_unisex anchor=Foot_L", "skill=vo_lv1_first_skill anchor=Hand_R", "scenePlane=dong-mon-gameplay-plane", "runtimeCheck=slot-bounds-follow-paperdoll-pose", "safe-runtime-fit=True", "runtimeAnimationSnapshot", "motionClip=TrainingCompletePose", "motionFrame=vo_complete_01", "paperDollPose=vo_lv1_training_complete", "runtimeDongMonAuthoredPassSnapshot", "DongMonAuthoredPass", "detail-density=readable", "runtimeMinimapReadabilitySnapshot", "MinimapReadability", "mode=compact-district-route", "route-text=short", "district-chips=academy,market,spirit,forge,guild,harbor", "world-links=icon-only", "selected-node-progress", "safe-local-no-backend"):
