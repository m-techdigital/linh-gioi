...
def main() -> int:
    ...
    require(
        ...
        "runtimeDongMonInteractionMarkerSourceSnapshot", "DongMonInteractionMarkerSource", "resource=LGOMaps/DongMonInteractionMarkers", "markers=5", "route=gatekeeper,training-stone,jump,dash,shadow-slime", "runtimeDongMonPlayerSceneFitSnapshot", "DongMonPlayerSceneFit", "footAnchor=bottom-center", "safe-runtime-player-evidence=True", "runtimeVoLv1ClassSliceSnapshot", "VoLv1ClassSlice", "resource=LGOClasses/VoLv1ClassSlice", "classId=vo", "slots=5", "ClassSkill:vo_lv1_first_skill", "top=top_vo_lv1_male", "runtimeSkillCue=True", "runtimeDongMonAuthoredPassSnapshot",
        "DongMonAuthoredPass",
        "detail-density=readable",
        "runtimeMinimapReadabilitySnapshot",
        "MinimapReadability",
