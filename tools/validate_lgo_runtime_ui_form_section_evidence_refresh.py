...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-FORM-SECTION-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_FORM_SECTION_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_form_section_evidence_refresh",
        "validate_lgo_runtime_ui_form_section_evidence_refresh.py",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI FORM SECTION EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_FORM_SECTION_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
