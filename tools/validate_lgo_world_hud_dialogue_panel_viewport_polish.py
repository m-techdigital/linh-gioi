...
def main() -> int:
    ...
    require(
        ...
        "LGO Dialogue Viewport Overlay Contract v1",
        ...
        "RuntimeUiButtonTier.Compact",
        "RuntimeUiButtonTier.Standard",
        ...
        "layout.DialogueSpeakerPortraitSize",
    ...
    require(
        ...
        "LGO Runtime UI Modal Shell Base v1",
        "ApplyModalBody(VisualElement body)",
        "ApplyModalFooter(VisualElement footer, float marginTop)",
        ...
        "LGO Runtime UI Overlay Placement Base v1",
    ...
    require(
        ...
        "ButtonTierCompactMinHeight = 38",
        "ButtonTierStandardMinHeight = 42",
    )
    require(
        ...
        "DialogueOverlayWidth",
        "DialogueOverlayInsetHorizontal",
        "DialogueOverlayInsetVertical",
