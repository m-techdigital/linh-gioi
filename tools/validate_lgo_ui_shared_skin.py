...
REQUIRED_SKIN_MARKERS = [
    ...
    "ApplyLgoInteractiveMotion",
    "ApplyLgoModalFiligreeFrame",
    "ApplyLgoCharacterHubSectionFrame",
    "ApplyLgoCharacterHubInsetFrame",
    "RemoveLgoOuterBorder",
    "ApplyLgoCharacterHubDetailCard",
    "ApplyLgoCharacterHubInspectorFacts",
    "ApplyLgoCharacterHubEquipmentSlot",
    ...
    "ApplyLgoCharacterHubMainTabs",
    "ApplyLgoCharacterHubInspectorColumn",
    "ApplyLgoCharacterHubActionRow",
...
REQUIRED_PARTIAL_MARKERS = {
    ...
    "CongDongLamArrivalHud.CharacterSelect.cs": [
        ...
        "await _productCharacterClient.ListProductCharactersAsync(",
        "await _productCharacterClient.LoadProductCharacterAsync(",
        "Không thể tải nhân vật. Vui lòng thử lại.",
    ...
    "CongDongLamArrivalHud.Register.cs": [
        ...
        "await _productAccountClient.RegisterAsync(",
    ...
    "CongDongLamArrivalHud.PasswordRecovery.cs": [
        ...
        "Map01A Password Recovery Confirm Password Field",
        ...
        "await _productAccountClient.RequestPasswordRecoveryAsync(",
        "await _productAccountClient.VerifyPasswordRecoveryAsync(",
    ...
    "CongDongLamArrivalHud.CharacterHub.cs": [
        ...
        "ApplyLgoCharacterHubActionRow(_hubSkillActionRow",
        "ApplyLgoCharacterHubActionRow(_hubPotentialActionRow",
        "ApplyLgoCharacterHubActionRow(_hubSpiritPetActionRow",
...
REQUIRED_TEST_MARKERS = [
    ...
    "CharacterSelectUsesThreeServerSlotsWithoutFakeProfileOrClassMutation",
    ...
    "CharacterHubFiveTabsUseSharedLayoutOwnershipRoles",
    "The approved five-tab rail must have one named layout owner",
