...
OUT_DIR="$ROOT/build/m5-guided-training-loop"
API_PORT="18087"
UNITY_PLAYER=""
...
usage() {
  cat <<'USAGE'
Usage:
  ./tools/run_m5_guided_training_loop_once.sh [--output-dir DIR] [--port PORT] [--unity-player PATH]

Runs the M5 guided training loop smoke against a real Spring Boot API process
...
python3 tools/m5_guided_training_loop_runtime.py "${args[@]}"
