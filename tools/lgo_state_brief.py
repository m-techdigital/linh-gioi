...
def main() -> int:
    ...
    print()
    print("## Project State")
    print(first_lines(project_state, 36) or "PROJECT_STATE_MISSING")
    print()
    print(limited_section(next_action, "## Quick Resume", 12) or "QUICK_RESUME_MISSING")
    print()
    print(limited_section(next_action, "## Next task", 8) or "NEXT_TASK_MISSING")
    print()
    print(limited_section(next_action, "## Current blocker", 18) or "CURRENT_BLOCKER_MISSING")
    print()
    print("## Next Task Advisor")
    print(advisor() or "ADVISOR_OUTPUT_MISSING")
    print()
    print("## Task Ledger Rollup")
    print(first_lines(rollup, 42) or "TASK_LEDGER_ROLLUP_MISSING")
