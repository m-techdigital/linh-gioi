...
def main() -> int:
    ...
    require('client/Unity/Assets/Game/World/Runtime/PlayableWorldController.cs', 'Sân luyện an toàn / Mục tiêu luyện tập', 'Lại gần vòng sáng', 'TargetDummyHitFlash', 'Chỉ là mô phỏng cục bộ')
    require('client/Unity/Assets/Game/UI/Runtime/M4PlayableClientController.cs', 'Luyện mục tiêu cục bộ', 'Kích hoạt phản hồi đánh thử cục bộ', 'Tấn công thử')
