...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-ONE-EDGE-LAYOUT-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_ONE_EDGE_LAYOUT_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_one_edge_layout_evidence_refresh",
        "validate_lgo_runtime_ui_one_edge_layout_evidence_refresh.py",
    )
    for rel in (
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI ONE-EDGE LAYOUT EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_ONE_EDGE_LAYOUT_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
