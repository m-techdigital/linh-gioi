...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-PRIMITIVE-THEME-SPACING-BRIDGE-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_PRIMITIVE_THEME_SPACING_BRIDGE_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_primitive_theme_spacing_bridge_evidence_refresh",
        "validate_lgo_runtime_ui_primitive_theme_spacing_bridge_evidence_refresh.py",
    )
    for rel in (
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI PRIMITIVE THEME SPACING BRIDGE EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_PRIMITIVE_THEME_SPACING_BRIDGE_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
