...
TWO_D_GATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contains": {
            ...
            "runtimeDongMonPlayerSceneFitSnapshot": ["DongMonPlayerSceneFit", "groundBandY=-1.58..-0.78", "footAnchor=bottom-center", "contactShadow=LayeredCharacter Shadow Slot Shadow", "playerSortOrder=2", "routeAnchors=gatekeeper,training-stone,jump,dash,shadow-slime", "DongMonPlayerGroundingSource", "authored-player-grounding=True", "routeAnchor=shadow-slime lane=combat-lane y=-1.16 sortBand=combat-front", "visitedGrounding=shadow-slime lane=combat-lane playerSort=6 shadowSort=5", "safe-runtime-player-evidence=True"],
            ...
            "runtimeVoLv1PaperDollAtlasSnapshot": ["VoLv1PaperDollAtlas", "resource=LGOClasses/VoLv1PaperDollAtlas", "parts=", "slot=OuterShirt", "anchor=Chest", "slot=Gloves", "anchor=Hand_R", "skillCue=vo_lv1_first_skill_trail", "cellSource=runtime-generated-atlas-cell", "part=chest_panel cell=torso_outer_vo_lv1", "part=hand_wrap_r cell=glove_r_vo_lv1", "skillCue=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedRuntimeArt=True", "VoLv1ApprovedRuntimeArt", "levelBand=1-30", "cells=13", "approvedCell=chest_panel cell=torso_outer_vo_lv1", "approvedCell=inner_shadow cell=base_torso_male", "approvedCell=pants_shadow_l cell=pants_vo_lv1", "approvedCell=pants_shadow_r cell=pants_vo_lv1", "approvedCell=hand_wrap_r cell=glove_r_vo_lv1", "approvedCell=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedCell=vo_lv1_first_skill_edge cell=skill_vo_lv1_palm_trail", "approvedCell=vo_lv1_first_skill_impact cell=skill_vo_lv1_palm_burst",
