...
TWO_D_GATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contains": {
            ...
            "runtimeLinhThanhPlazaHubSnapshot": ["PlazaHubRuntime", "unlocked=True", "npc=gate-guide", "board=event-local-preview", "interaction=board-preview-open", "safe-local-no-backend"],
