...
TWO_D_GATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contains": {
            ...
            "runtimeVoLv1ClassSliceSnapshot": ["VoLv1ClassSlice", "resource=LGOClasses/VoLv1ClassSlice", "classId=vo", "slots=5", "ClassSkill:vo_lv1_first_skill", "skillAnchor=Hand_R", "runtimeLoadout=LayeredEquipment", "top=top_vo_lv1_male", "runtimeSkillCue=True", "safe-no-source-image=True", "safe-no-3d=True"],
            "runtimeVoLv1PaperDollAtlasSnapshot": ["VoLv1PaperDollAtlas", "resource=LGOClasses/VoLv1PaperDollAtlas", "parts=", "slot=OuterShirt", "anchor=Chest", "slot=Gloves", "anchor=Hand_R", "skillCue=vo_lv1_first_skill_trail", "active=True", "pose=vo_lv1_training_complete", "safe-no-source-image=True", "safe-no-3d=True"],
