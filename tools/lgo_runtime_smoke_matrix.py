...
TWO_D_GATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contains": {
            ...
            "runtimeVoLv1PaperDollAtlasSnapshot": ["VoLv1PaperDollAtlas", "resource=LGOClasses/VoLv1PaperDollAtlas", "parts=", "slot=OuterShirt", "anchor=Chest", "slot=Gloves", "anchor=Hand_R", "skillCue=vo_lv1_first_skill_trail", "cellSource=runtime-generated-atlas-cell", "part=chest_panel cell=torso_outer_vo_lv1", "part=hand_wrap_r cell=glove_r_vo_lv1", "skillCue=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedRuntimeArt=True", "VoLv1ApprovedRuntimeArt", "levelBand=1-30", "approvedCell=chest_panel cell=torso_outer_vo_lv1", "approvedCell=hand_wrap_r cell=glove_r_vo_lv1", "approvedCell=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "productionAtlas=vo-lv1-starter-atlas-v1", "importMode=layered-psb-or-spritesheet", "texturePolicy=approved-original-2d-art-only", "requiredCell=torso_outer_vo_lv1", "requiredCell=skill_vo_lv1_palm_burst", "rigJoint=Hand_R", "motionClip=vo_lv1_first_skill", "replacementGate=preserve-runtime-fit-contract", "poseOffsets=", "pose=vo_jump_lift", "pose=vo_dash_stretch", "currentPose=vo_lv1_training_complete", "active=True", "pose=vo_lv1_training_complete", "safe-runtime-motion=True", "safe-no-source-image=True", "safe-no-3d=True"],
