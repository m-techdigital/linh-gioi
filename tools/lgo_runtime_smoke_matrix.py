...
TWO_D_GATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "contains": {
            ...
            "runtimeVoLv1PaperDollAtlasSnapshot": ["VoLv1PaperDollAtlas", "resource=LGOClasses/VoLv1PaperDollAtlas", "parts=", "slot=OuterShirt", "anchor=Chest", "slot=Gloves", "anchor=Hand_R", "skillCue=vo_lv1_first_skill_trail", "poseOffsets=", "pose=vo_jump_lift", "pose=vo_dash_stretch", "currentPose=vo_lv1_training_complete", "active=True", "pose=vo_lv1_training_complete", "safe-runtime-motion=True", "safe-no-source-image=True", "safe-no-3d=True"],
