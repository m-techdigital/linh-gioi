...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-HEADER-DIALOGUE-BUTTON-METRICS-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_HEADER_DIALOGUE_BUTTON_METRICS_EVIDENCE_REFRESH_READY",
        "npc-dialogue.png",
        "session-menu.png",
        "world-hub.png",
        "VISUAL_RUNTIME_PASS",
    ...
    require(
        ...
        "runtime_ui_header_dialogue_button_metrics_evidence_refresh",
        "validate_lgo_runtime_ui_header_dialogue_button_metrics_evidence_refresh.py",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI HEADER DIALOGUE BUTTON METRICS EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_HEADER_DIALOGUE_BUTTON_METRICS_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
