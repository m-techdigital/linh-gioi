...
class ValidateMap01AUiReviewCatalogTests(unittest.TestCase):
    def test_current_catalog_uses_approved_five_tab_player_and_excludes_legacy_class_select(self) -> None:
        ...
        self.assertIn("build/map01a-spirit-pet-crop-runtime-v1/spirit-pet.png", current_paths)
        self.assertIn("build/map01a-spirit-pet-crop-runtime-v1/bag-search-binh-mau-selected.png", current_paths)
    ...
    def _fixture(self) -> tempfile.TemporaryDirectory[str]:
        ...
        doc.write_text(
            ...
            "five tabs: `build/map01a-spirit-pet-crop-runtime-v1/character-info.png`, `build/map01a-spirit-pet-crop-runtime-v1/bag.png`, `build/map01a-spirit-pet-crop-runtime-v1/bag-search-binh-mau.png`, `build/map01a-spirit-pet-crop-runtime-v1/bag-search-binh-mau-selected.png`, `build/map01a-spirit-pet-crop-runtime-v1/skills.png`, `build/map01a-spirit-pet-crop-runtime-v1/potential.png`, `build/map01a-spirit-pet-crop-runtime-v1/spirit-pet.png`, `build/map01a-spirit-pet-crop-runtime-v1/manifest.json`\n"
