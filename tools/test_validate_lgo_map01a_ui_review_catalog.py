...
class ValidateMap01AUiReviewCatalogTests(unittest.TestCase):
    def test_current_catalog_uses_approved_five_tab_player_and_excludes_legacy_class_select(self) -> None:
        ...
        self.assertIn("build/map01a-inventory-search-runtime-v2/spirit-pet.png", current_paths)
    ...
    def _fixture(self) -> tempfile.TemporaryDirectory[str]:
        ...
        doc.write_text(
            ...
            "## Current evidence\n\n"
            "entry/login: `build/map01a-entry-real-fields-runtime-v2/entry-login.png`, `build/map01a-entry-real-fields-runtime-v2/manifest.json`\n"
            "five tabs: `build/map01a-inventory-search-runtime-v2/character-info.png`, `build/map01a-inventory-search-runtime-v2/bag.png`, `build/map01a-inventory-search-runtime-v2/skills.png`, `build/map01a-inventory-search-runtime-v2/potential.png`, `build/map01a-inventory-search-runtime-v2/spirit-pet.png`, `build/map01a-inventory-search-runtime-v2/manifest.json`\n"
        ...
        write_json(root / "build/map01a-entry-real-fields-runtime-v2/manifest.json", {
        ...
        (root / "build/map01a-entry-real-fields-runtime-v2/entry-login.png").write_bytes(b"png")
    ...
    def test_rejects_os_input_capture_for_modal_evidence(self) -> None:
        with self._fixture() as temp:
            manifest = Path(temp) / "build/map01a-entry-real-fields-runtime-v2/manifest.json"
