...
class ValidateMap01AUiReviewCatalogTests(unittest.TestCase):
    ...
    def _fixture(self) -> tempfile.TemporaryDirectory[str]:
        ...
        doc.write_text(
            ...
            "five tabs: `build/map01a-shared-layout-runtime-v4/character-info.png`, `build/map01a-shared-layout-runtime-v4/bag.png`, `build/map01a-shared-layout-runtime-v4/bag-search-binh-mau.png`, `build/map01a-shared-layout-runtime-v4/bag-search-binh-mau-selected.png`, `build/map01a-shared-layout-runtime-v4/skills.png`, `build/map01a-shared-layout-runtime-v4/potential.png`, `build/map01a-shared-layout-runtime-v4/spirit-pet.png`, `build/map01a-shared-layout-runtime-v4/manifest.json`\n"
