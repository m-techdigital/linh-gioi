...
source_only() {
  ...
  if [[ -f tools/validate_lgo_runtime_ui_component_base_reuse_audit.py ]]; then
    run_phase runtime_ui_component_base_reuse_audit python3.12 tools/validate_lgo_runtime_ui_component_base_reuse_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_action_row_base_audit.py ]]; then
    run_phase runtime_ui_action_row_base_audit python3.12 tools/validate_lgo_runtime_ui_action_row_base_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_input_field_base_audit.py ]]; then
    run_phase runtime_ui_input_field_base_audit python3.12 tools/validate_lgo_runtime_ui_input_field_base_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_input_field_evidence_refresh.py ]]; then
    run_phase runtime_ui_input_field_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_input_field_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_form_section_base_audit.py ]]; then
    run_phase runtime_ui_form_section_base_audit python3.12 tools/validate_lgo_runtime_ui_form_section_base_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_status_chip_base_audit.py ]]; then
    run_phase runtime_ui_status_chip_base_audit python3.12 tools/validate_lgo_runtime_ui_status_chip_base_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_icon_status_row_base_audit.py ]]; then
    run_phase runtime_ui_icon_status_row_base_audit python3.12 tools/validate_lgo_runtime_ui_icon_status_row_base_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_icon_status_row_evidence_refresh.py ]]; then
    run_phase runtime_ui_icon_status_row_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_icon_status_row_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_combat_button_metrics_audit.py ]]; then
    run_phase runtime_ui_combat_button_metrics_audit python3.12 tools/validate_lgo_runtime_ui_combat_button_metrics_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_responsive_button_metrics_audit.py ]]; then
    run_phase runtime_ui_responsive_button_metrics_audit python3.12 tools/validate_lgo_runtime_ui_responsive_button_metrics_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_responsive_button_metrics_evidence_refresh.py ]]; then
    run_phase runtime_ui_responsive_button_metrics_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_responsive_button_metrics_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_header_dialogue_button_metrics_audit.py ]]; then
    run_phase runtime_ui_header_dialogue_button_metrics_audit python3.12 tools/validate_lgo_runtime_ui_header_dialogue_button_metrics_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_header_dialogue_button_metrics_evidence_refresh.py ]]; then
    run_phase runtime_ui_header_dialogue_button_metrics_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_header_dialogue_button_metrics_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_label_font_metrics_audit.py ]]; then
    run_phase runtime_ui_label_font_metrics_audit python3.12 tools/validate_lgo_runtime_ui_label_font_metrics_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_label_font_metrics_evidence_refresh.py ]]; then
    run_phase runtime_ui_label_font_metrics_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_label_font_metrics_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_typography_ownership_split_review.py ]]; then
    run_phase runtime_ui_typography_ownership_split_review python3.12 tools/validate_lgo_runtime_ui_typography_ownership_split_review.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_character_hall_content_density_polish.py ]]; then
    run_phase runtime_ui_character_hall_content_density_polish python3.12 tools/validate_lgo_runtime_ui_character_hall_content_density_polish.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_density_adoption_scan.py ]]; then
    run_phase runtime_ui_density_adoption_scan python3.12 tools/validate_lgo_runtime_ui_density_adoption_scan.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_controller_padding_profile_candidate_audit.py ]]; then
    run_phase runtime_ui_controller_padding_profile_candidate_audit python3.12 tools/validate_lgo_runtime_ui_controller_padding_profile_candidate_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_component_margin_token_audit.py ]]; then
    run_phase runtime_ui_component_margin_token_audit python3.12 tools/validate_lgo_runtime_ui_component_margin_token_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_component_margin_token_evidence_refresh.py ]]; then
    run_phase runtime_ui_component_margin_token_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_component_margin_token_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_primitive_theme_spacing_bridge_audit.py ]]; then
    run_phase runtime_ui_primitive_theme_spacing_bridge_audit python3.12 tools/validate_lgo_runtime_ui_primitive_theme_spacing_bridge_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_primitive_theme_spacing_bridge_evidence_refresh.py ]]; then
    run_phase runtime_ui_primitive_theme_spacing_bridge_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_primitive_theme_spacing_bridge_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_primitive_size_token_audit.py ]]; then
    run_phase runtime_ui_primitive_size_token_audit python3.12 tools/validate_lgo_runtime_ui_primitive_size_token_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_controller_local_style_drift_scan.py ]]; then
    run_phase runtime_ui_controller_local_style_drift_scan python3.12 tools/validate_lgo_runtime_ui_controller_local_style_drift_scan.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_controller_local_style_evidence_refresh.py ]]; then
    run_phase runtime_ui_controller_local_style_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_controller_local_style_evidence_refresh.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_status_composition_cleanup.py ]]; then
    run_phase runtime_ui_status_composition_cleanup python3.12 tools/validate_lgo_runtime_ui_status_composition_cleanup.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_status_composition_evidence_refresh.py ]]; then
    run_phase runtime_ui_status_composition_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_status_composition_evidence_refresh.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_evidence_state_helper.py ]]; then
    run_phase runtime_ui_evidence_state_helper python3.12 tools/validate_lgo_runtime_ui_evidence_state_helper.py
  fi
  if [[ -f tools/validate_lgo_world_hud_header_block_review.py ]]; then
    run_phase world_hud_header_block_review python3.12 tools/validate_lgo_world_hud_header_block_review.py
  fi
  if [[ -f tools/validate_lgo_world_hud_row_helper_coverage_audit.py ]]; then
    run_phase world_hud_row_helper_coverage_audit python3.12 tools/validate_lgo_world_hud_row_helper_coverage_audit.py
  fi
  if [[ -f tools/validate_lgo_world_hud_row_helper_evidence_refresh.py ]]; then
    run_phase world_hud_row_helper_evidence_refresh python3.12 tools/validate_lgo_world_hud_row_helper_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_style_ownership_drift_audit.py ]]; then
    run_phase runtime_ui_style_ownership_drift_audit python3.12 tools/validate_lgo_runtime_ui_style_ownership_drift_audit.py
  fi
  ...
  if [[ -f tools/validate_lgo_runtime_ui_responsive_padding_profile_audit.py ]]; then
    run_phase runtime_ui_responsive_padding_profile_audit python3.12 tools/validate_lgo_runtime_ui_responsive_padding_profile_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_responsive_padding_profile_evidence_refresh.py ]]; then
    run_phase runtime_ui_responsive_padding_profile_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_responsive_padding_profile_evidence_refresh.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_session_menu_padding_profile_audit.py ]]; then
    run_phase runtime_ui_session_menu_padding_profile_audit python3.12 tools/validate_lgo_runtime_ui_session_menu_padding_profile_audit.py
  fi
  if [[ -f tools/validate_lgo_runtime_ui_session_menu_padding_profile_evidence_refresh.py ]]; then
    run_phase runtime_ui_session_menu_padding_profile_evidence_refresh python3.12 tools/validate_lgo_runtime_ui_session_menu_padding_profile_evidence_refresh.py
  fi
  ...
  run_phase python_compile python3.12 -m py_compile \
    ...
    tools/validate_lgo_runtime_ui_component_margin_token_audit.py \
    tools/validate_lgo_runtime_ui_component_margin_token_evidence_refresh.py \
    tools/validate_lgo_runtime_ui_primitive_theme_spacing_bridge_audit.py \
    ...
    tools/validate_lgo_runtime_ui_status_composition_cleanup.py \
    tools/validate_lgo_runtime_ui_status_composition_evidence_refresh.py \
    ...
    tools/validate_lgo_runtime_ui_evidence_state_helper.py \
    tools/validate_lgo_world_hud_header_block_review.py \
    tools/validate_lgo_world_hud_row_helper_coverage_audit.py \
    ...
    tools/validate_lgo_runtime_ui_responsive_padding_profile_audit.py \
    tools/validate_lgo_runtime_ui_responsive_padding_profile_evidence_refresh.py \
    tools/validate_lgo_runtime_ui_session_menu_padding_profile_audit.py \
    tools/validate_lgo_runtime_ui_session_menu_padding_profile_evidence_refresh.py \
