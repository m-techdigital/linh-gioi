...
def main() -> int:
    require(
        "docs/tasks/LGO-RUNTIME-UI-ICON-STATUS-ROW-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_ICON_STATUS_ROW_EVIDENCE_REFRESH_READY",
        "NewIconStatusRow",
    ...
    require(
        ...
        "runtime_ui_icon_status_row_evidence_refresh",
        "validate_lgo_runtime_ui_icon_status_row_evidence_refresh.py",
    )
    require(
    ...
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI ICON STATUS ROW EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_ICON_STATUS_ROW_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
