...
def check_manifest() -> None:
    ...
    for name in ["session-menu.png", "world-hub.png", "npc-dialogue.png", "target-dummy-state.png"]:
...
def main() -> int:
    ...
    check_manifest()
    require(
        "docs/tasks/LGO-RUNTIME-UI-SESSION-MENU-PADDING-PROFILE-EVIDENCE-REFRESH-v1.0.md",
        "LGO_RUNTIME_UI_SESSION_MENU_PADDING_PROFILE_EVIDENCE_REFRESH_READY",
    ...
    require(
        ...
        "runtime_ui_session_menu_padding_profile_evidence_refresh",
        "validate_lgo_runtime_ui_session_menu_padding_profile_evidence_refresh.py",
    )
    check_frozen()
    if ERRORS:
        print("LGO RUNTIME UI SESSION MENU PADDING PROFILE EVIDENCE REFRESH VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_RUNTIME_UI_SESSION_MENU_PADDING_PROFILE_EVIDENCE_REFRESH_VALIDATION_PASS")
    return 0
