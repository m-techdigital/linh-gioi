...
TWO_D_ONBOARDING_VIEWS: list[dict[str, Any]] = [
...

    {
        ...
        "requiredManifest": ["runtimeHubTransitionSnapshot", "runtimeLinhThanhAcademyShellSnapshot", "runtimeLinhThanhMarketShellSnapshot", "runtimeLinhThanhSpiritTempleShellSnapshot", "runtimeLinhThanhResidentialShellSnapshot", "hudSnapshot"],
