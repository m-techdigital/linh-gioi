...
def verify_current() -> dict[str, Any]:
    ...
    for token in ("VoLv1PaperDollAtlas", "cellSource=runtime-generated-atlas-cell", "part=chest_panel cell=torso_outer_vo_lv1", "part=hand_wrap_r cell=glove_r_vo_lv1", "skillCue=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail", "approvedRuntimeArt=True", "VoLv1ApprovedRuntimeArt", "levelBand=1-30", "approvedCell=chest_panel cell=torso_outer_vo_lv1", "approvedCell=hand_wrap_r cell=glove_r_vo_lv1", "approvedCell=vo_lv1_first_skill_trail cell=skill_vo_lv1_palm_trail",
