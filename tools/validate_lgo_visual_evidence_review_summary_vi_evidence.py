...
def main() -> int:
    ...
    reject(
        "build/visual-evidence/latest/visual-runtime-evidence-review-vi.md",
        "Trạng thái: `VISUAL_RUNTIME_PASS`",
        "Status: `VISUAL_RUNTIME_PASS`",
    )
    require(
    ...
    require(
        "docs/tasks/LGO-VISUAL-EVIDENCE-REVIEW-SUMMARY-VI-EVIDENCE-v1.0.md",
        "LGO_VISUAL_EVIDENCE_REVIEW_SUMMARY_VI_EVIDENCE_READY",
    ...
    require(
        ...
        "visual_evidence_review_summary_vi_evidence",
        "validate_lgo_visual_evidence_review_summary_vi_evidence.py",
    )
    check_frozen()
    if ERRORS:
        print("LGO VISUAL EVIDENCE REVIEW SUMMARY VI EVIDENCE VALIDATION FAILED", file=sys.stderr)
        for error in ERRORS:
            print(" - " + error, file=sys.stderr)
        return 1
    print("LGO_VISUAL_EVIDENCE_REVIEW_SUMMARY_VI_EVIDENCE_VALIDATION_PASS")
    return 0
