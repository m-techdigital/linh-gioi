...
def main() -> int:
    require(
        ...
        'Đang xem Chém Gió: cung vàng hiện quanh người chơi',
        'Đang xem Trói Bóng: vòng cảnh báo đỏ khoanh Bóng Tối',
        'Đang xem Hộ Linh: mạch sáng bảo hộ',
    ...
    require(
        ...
        'RuntimeUiOverflowGuard.ApplyResponsiveColumns(actions, 3, 6',
        ...
        'RuntimeUiFactory.NewCompactSecondaryButton',
    ...
    if 'Cooldown' in world:
        ...
        if 'M6_MINIMAL_LOCAL_COMBAT_FOUNDATION_SOURCE_READY_v0.34.0' not in m6_doc or 'local/non-authoritative' not in m6_doc:
            errors.append('world skill preview contains Cooldown without M6 local/non-authoritative approval')
