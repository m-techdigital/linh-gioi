...
def main() -> int:
    ...
    require(
        ...
        "LGO Login Mobile Centered Control Overlay v1",
        "RuntimeUiOverflowGuard.ApplyViewportOverlaySurface(",
    ...
    require(
        ...
        "LoginMobileControlColumnWidth",
        "LoginMobileControlColumnInsetHorizontal",
        "LoginMobileControlColumnTop",
        "LoginMobileControlColumnMaxHeight",
        ...
        "LoginControlColumnWidth => IsMobile ? new Length(LoginMobileControlColumnWidth) : IsTablet ? Length.Percent(56) : Length.Percent(54)",
    )
    require(
