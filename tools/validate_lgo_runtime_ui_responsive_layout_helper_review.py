...
def main() -> int:
    require(
        ...
        "screenWidth > 0 ? screenWidth : DefaultViewportWidth",
        "screenHeight > 0 ? screenHeight : DefaultViewportHeight",
        'width <= MobileMaxWidth || height <= MobileMaxHeight ? "mobile" : width <= TabletMaxWidth ? "tablet" : "desktop"',
        "LoginLogoWidth",
        "LoginCardWidth",
        "LoginButtonFontSize",
    )
