...
def main() -> int:
    ...
    require('docs/tasks/M5-LOCAL-SETTINGS-v0.28.0.md', 'M5_LOCAL_SETTINGS_RUNTIME_CLOSED_LOCAL_v0.28.0', 'No persistence')
    ...
    if errors:
        print('M5 LOCAL SETTINGS VALIDATION FAILED', file=sys.stderr)
        for error in errors:
            print(' - ' + error, file=sys.stderr)
        return 1
    print('M5 LOCAL SETTINGS VALIDATION PASS')
    return 0
