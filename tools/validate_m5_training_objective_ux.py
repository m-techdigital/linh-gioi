...
def main() -> int:
    require('client/Unity/Assets/Game/World/Runtime/PlayableWorldController.cs', 'Mục tiêu 1/2', 'Mục tiêu 2/2', 'Bước 1:', 'Bước 2:', 'đường đá', 'Sân luyện an toàn / cảnh báo bóng phía đông')
    require('client/Unity/Assets/Game/UI/Runtime/M4PlayableClientController.cs', 'Hoàn tất hướng dẫn. Mở Menu để lưu vị trí hoặc về điện nhân vật.', 'Bước 1 Người Giữ Cổng / Bước 2 Đá Luyện', 'Lưu vị trí', 'Về điện nhân vật', 'Thoát')
