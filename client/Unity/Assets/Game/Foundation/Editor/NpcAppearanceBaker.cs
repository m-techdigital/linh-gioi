...
namespace LinhGioi.Foundation.Editor
{
    public static class NpcAppearanceBaker
    {
        ...
        private const string PartsRoot = Root + "Editor/KeeperParts/";
        ...
        public static void BakeKeeper()
        {
            ...
            var prefabPath = Root + "Resources/LGOGateKeeperCandidate.prefab";
            var instance = (GameObject)PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath<GameObject>(Root + "GateKeeper.fbx"));
            try
            {
                ...
                recipe = Save(recipe, PartsRoot + "KeeperRecipe.asset");
        ...
        public static Mesh Merge(NpcAppearanceRecipe recipe)
        {
            ...
            var mesh = new Mesh { name = "Keeper shared assembled appearance", indexFormat = vertices.Count > 65535 ? UnityEngine.Rendering.IndexFormat.UInt32 : UnityEngine.Rendering.IndexFormat.UInt16 };
