...
namespace LinhGioi.Art
{
    public static class CombatPlaceholderAssets
    {
        ...
        public static Sprite CooldownReady => LgoVisualAssetRegistryV3B.CooldownReady ?? LoadSprite("cooldown-ring-ready-v0450");
        public static Sprite CooldownActive => LgoVisualAssetRegistryV3B.CooldownActive ?? LoadSprite("cooldown-ring-cooldown-v0450");
        public static Sprite WindSlashFrame01 => LgoVisualAssetRegistryV3B.WindSlashFrame01 ?? LoadSprite("skill-wind-slash-frame-01-v0450");
        public static Sprite ImpactSpark => LgoVisualAssetRegistryV3B.ImpactSpark ?? LoadSprite("skill-impact-spark-v0450");
        ...
        public static Texture2D CooldownReadyTexture => LgoVisualAssetRegistryV3B.CooldownReadyTexture ?? LoadTexture("cooldown-ring-ready-v0450");
