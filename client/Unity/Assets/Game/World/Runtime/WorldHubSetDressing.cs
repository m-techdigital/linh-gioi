...
namespace LinhGioi.World
{
    internal static class WorldHubSetDressing
    {
            ...
            bool narrowViewport)
        {
            ...
            createBillboard("LGO World Cherry Tree Runtime Sprite V3B", LgoVisualAssetRegistryV3B.TreeCherry, Point(-5.25f, 0.2f, 1.55f, mobileViewport, narrowViewport), Scale(1.02f, 0.88f, 0.70f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Pine Tree Runtime Sprite V3B", LgoVisualAssetRegistryV3B.TreePine, Point(5.25f, 0.2f, 2.35f, mobileViewport, narrowViewport), Scale(0.94f, 0.82f, 0.66f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Cherry Tree Far Runtime Sprite V3B", LgoVisualAssetRegistryV3B.TreeCherry, Point(5.1f, 0.16f, -0.95f, mobileViewport, narrowViewport), Scale(0.54f, 0.46f, 0.34f, mobileViewport, narrowViewport), 0);
            ...
            createBillboard("LGO World Pine Tree Far Runtime Sprite V3B", LgoVisualAssetRegistryV3B.TreePine, Point(-5.55f, 0.16f, 3.9f, mobileViewport, narrowViewport), Scale(0.58f, 0.50f, 0.38f, mobileViewport, narrowViewport), 0);
            ...
            createBillboard("LGO World Cherry Tree Back Ridge Sprite V3B", LgoVisualAssetRegistryV3B.TreeCherry, Point(-6.15f, 0.12f, 5.35f, mobileViewport, narrowViewport), Scale(0.42f, 0.36f, 0.26f, mobileViewport, narrowViewport), -1);
            ...
            createBillboard("LGO World Lantern North Runtime Sprite V3B", LgoVisualAssetRegistryV3B.LanternProp, Point(-1.15f, 0.15f, 5.55f, mobileViewport, narrowViewport), Scale(0.36f, 0.32f, 0.24f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Lantern South Runtime Sprite V3B", LgoVisualAssetRegistryV3B.LanternProp, Point(1.25f, 0.15f, -5.45f, mobileViewport, narrowViewport), Scale(0.36f, 0.32f, 0.24f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Lantern Back West Sprite V3B", LgoVisualAssetRegistryV3B.LanternProp, Point(-3.65f, 0.12f, 5.65f, mobileViewport, narrowViewport), Scale(0.30f, 0.26f, 0.20f, mobileViewport, narrowViewport), 0);
            ...
            createBillboard("LGO World Lantern Back East Sprite V3B", LgoVisualAssetRegistryV3B.LanternProp, Point(3.70f, 0.12f, 5.45f, mobileViewport, narrowViewport), Scale(0.30f, 0.26f, 0.20f, mobileViewport, narrowViewport), 0);
            ...
            createBillboard("LGO World Rock Moss Runtime Sprite V3B", LgoVisualAssetRegistryV3B.RockMoss, Point(-2.15f, 0.15f, -1.95f, mobileViewport, narrowViewport), Scale(0.48f, 0.40f, 0.30f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Rock Moss East Runtime Sprite V3B", LgoVisualAssetRegistryV3B.RockMoss, Point(2.35f, 0.12f, 4.95f, mobileViewport, narrowViewport), Scale(0.30f, 0.26f, 0.20f, mobileViewport, narrowViewport), 0);
            ...
            createBillboard("LGO World Rock Moss Back West Runtime Sprite V3B", LgoVisualAssetRegistryV3B.RockMoss, Point(-4.25f, 0.10f, 4.75f, mobileViewport, narrowViewport), Scale(0.24f, 0.20f, 0.16f, mobileViewport, narrowViewport), -1);
            ...
            createBillboard("LGO World Cultivation Banner Runtime Sprite V3B", LgoVisualAssetRegistryV3B.BannerCultivation, Point(4.25f, 0.2f, -3.9f, mobileViewport, narrowViewport), Scale(0.46f, 0.38f, 0.28f, mobileViewport, narrowViewport), 2);
            ...
            createBillboard("LGO World Cultivation Banner West Runtime Sprite V3B", LgoVisualAssetRegistryV3B.BannerCultivation, Point(-5.3f, 0.16f, -3.55f, mobileViewport, narrowViewport), Scale(0.34f, 0.28f, 0.22f, mobileViewport, narrowViewport), 1);
            ...
            createBillboard("LGO World Bridge Wood Runtime Sprite V3B", LgoVisualAssetRegistryV3B.BridgeWood, Point(-3.25f, 0.1f, -4.15f, mobileViewport, narrowViewport), Scale(0.72f, 0.58f, 0.44f, mobileViewport, narrowViewport), 1);
