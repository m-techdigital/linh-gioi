...
Runtime port 2026-09-08: `CityArchitectureVisuals.House/Roof` dùng lại ngôn ngữ cửa song, gallery, áp mái, ngói nổi và gối đỡ trên footprint phố hiện có. Không đọc JSON catalog hoặc export trực tiếp Blender; café đầy đủ/townhouse ba tầng vẫn authoring-only. PC capture riêng `--lgo-city-quality-review <directory>` gồm ba góc gameplay và bốn góc kiến trúc, đi từ arrival tới sân rồi quay lại. Evidence `build/visual-evidence/city-reference-door-desktop/review.json`: đã xem, còn art cần sửa; không coi build thành công là final.
