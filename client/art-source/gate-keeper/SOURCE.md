...
Upper wardrobe2026-09-08: vai cong3 tầng, tay áo phồng hơn, cape quad liền với hem chẻ giữa; bỏ flare cũ dưới đai và632 mặt quần bị che. Master14objects,10slots. Xuất trực tiếp master với `--wardrobe-master --joined-source build/…/keeper.blend`; bản ghép chỉ dẫn xuất. Capture đã ép/xác minh viewport1920×1080,6 ảnh NPC đã xem tại `upper-envelope-desktop/review.json`; còn tiếp giáp cape/giáp tay, phom chưa final. Không dùng migration lại trên source đã chuyển.
