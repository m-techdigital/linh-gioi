...
- [ ] **Step 5: Keep diff local; do not commit until Task 3 source/tool tests are green**

### Task 2: Accurate Menu help and blocking matrix
...
### Task 3: Deterministic whole-flow evidence runner
...
- [ ] **Step 5: Run Python tests and focused Unity capture-contract tests GREEN**

### Task 4: Source regression gates and P0 commit
**Files:**
