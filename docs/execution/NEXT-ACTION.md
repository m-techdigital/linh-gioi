...
```json
{"activeTask":"LGO_RIGID_OUTFIT_PILOT_01","phase":"FINAL_OUTFIT1_NATIVE_LAYER_ART_AUTHORING","status":"CONTINUE","method":"DESIGN_FIRST_NATIVE_LAYERED_RIGID_AUTHORING","sourceProfile":"lgo_character_canvas_1024x1536_v1","requiredMotion":["Idle","Walk","Run","Jump","Attack","Roll"],"motionAuthority":"build/character-base-v3/male-old-base-six-pose-reference.png","currentDesignEvidence":"build/rigid-outfit-pilot/final-1-coherent-body-design-v9/canonical-bind-profile-v1/male-female-canonical-bind-review-v1.png","jointContract":"docs/art/LGO-RIGID-JOINT-AND-LAYER-AUTHORING-CONTRACT-v1.md","jointProfile":"docs/art/data/lgo-rigid-joint-interface-profile-v1.json","moduleTopology":"build/rigid-outfit-pilot/final-1-three-quarter-design-v5/outfit-module-topology-v2.json","rejectedSourceEvidence":["build/rigid-outfit-pilot/rejected-iterations/v7-composite-mask-source","build/rigid-outfit-pilot/rejected-iterations/v7-imagegen-atlas-invalid","build/rigid-outfit-pilot/rejected-iterations/v8-procedural-primitive-body-source"],"currentSourceAuthorityValid":false,"bodyBindCalibrated":false,"technicalInvariantStatus":"CANONICAL_REGISTRATION_AND_KRITA_TEMPLATE_ROUNDTRIP_PASS","visualStatus":"V9_COHERENT_BIND_READY_AUTHOR_LAYERS_EMPTY","stopCondition":"NATIVE_BODY_LAYER_ART_REQUIRED","bodyModuleCount":16,"outfitModuleCount":25,"redesignOutfit1Allowed":true,"nativeLayerAuthoringAllowed":true,"proceduralPrimitiveBodyAllowed":false,"compositeSlicingAllowed":false,"imagegenAtlasAsSourceAllowed":false,"rigImplementationAllowed":false,"outfit2IntegrationAllowed":false,"classExpansionAllowed":false,"perPoseAssetsAllowed":false,"deformationAllowed":false,"animatedScaleAllowed":false,"canonicalBindProfileEvidence":"build/rigid-outfit-pilot/final-1-coherent-body-design-v9/canonical-bind-profile-v1/canonical-bind-profile-v1.json","sourceTemplateValid":true,"sourceArtValid":false,"kritaRoundtripEvidence":"build/rigid-outfit-pilot/final-1-coherent-body-design-v9/krita-native-template-roundtrip-v1/roundtrip-report.json"}
```
...
**VẼ ART VÀ HIDDEN GEOMETRY VÀO 16 AUTHOR LAYER ĐÃ MỞ LẠI ĐƯỢC.** Dùng clean design v9 làm underlay reference và canonical landmark map làm guide. Vẽ từng body part hoàn chỉnh trong KRA nam/nữ, xuất RGBA common-canvas, rồi đo `Wb` trên alpha của từng layer. Body-only phải qua rotation board trước khi vẽ outfit. Sau đó outfit mới được author trực tiếp trên cùng bind source. Không cắt composite và không tách atlas ImageGen.
