...
Review whether the growing playable UI controller should split screen construction into reusable factories or remain consolidated until stronger behavior coverage exists. Marker: `LGO_RUNTIME_UI_STYLE_DUPLICATION_AUDIT_READY`. Prefer a conservative decision backed by file-size, dependency, and validator evidence.
