...
- Current reason: Login CTA backing and Gate Keeper grounding were tightened with no new image payload; source-only and desktop visual evidence are stable, no `VISUAL_RUNTIME_PASS` claim.
