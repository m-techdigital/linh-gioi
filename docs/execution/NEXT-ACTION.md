...
Continue reducing repeated post-login UI composition now that evidence and asset governance gates are stronger. Marker ready from the sequential evidence-gate policy: `LGO_EVIDENCE_GATE_SEQUENTIAL_RUN_POLICY_READY`.
