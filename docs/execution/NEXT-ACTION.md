...
- Current reason: Character Hall first-time create state now uses a narrower centered form and warmer game copy; source gates and desktop visual evidence are stable, and no `VISUAL_RUNTIME_PASS` is claimed.
