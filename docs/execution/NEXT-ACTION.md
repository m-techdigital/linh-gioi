...
```json
{"activeTask":"LGO_RIGID_OUTFIT_PILOT_01","phase":"FINAL_OUTFIT1_NATIVE_LAYERED_SOURCE_AUTHORING","status":"FIX_REQUIRED","method":"NATIVE_LAYERED_BODY_FIRST_RIGID_AUTHORING","sourceProfile":"lgo_character_canvas_1024x1536_v1","requiredMotion":["Idle","Walk","Run","Jump","Attack","Roll"],"motionAuthority":"build/character-base-v3/male-old-base-six-pose-reference.png","currentDesignEvidence":"build/rigid-outfit-pilot/final-1-body-outfit-bind-design-v6/body-only-and-dressed-neutral-pair-v1.png","jointContract":"docs/art/LGO-RIGID-JOINT-AND-LAYER-AUTHORING-CONTRACT-v1.md","jointProfile":"docs/art/data/lgo-rigid-joint-interface-profile-v1.json","moduleTopology":"build/rigid-outfit-pilot/final-1-three-quarter-design-v5/outfit-module-topology-v2.json","rejectedSourceEvidence":["build/rigid-outfit-pilot/rejected-iterations/v7-composite-mask-source","build/rigid-outfit-pilot/rejected-iterations/v7-imagegen-atlas-invalid"],"currentSourceAuthorityValid":false,"bodyBindCalibrated":false,"technicalInvariantStatus":"FORMULA_VALID_SOURCE_AUTHORING_METHOD_RESET","visualStatus":"V6_STYLE_BOARD_ONLY_NO_NATIVE_LAYERED_SOURCE","stopCondition":"NATIVE_LAYERED_BODY_SOURCE_REQUIRED","bodyModuleCount":16,"outfitModuleCount":25,"redesignOutfit1Allowed":true,"nativeLayerAuthoringAllowed":true,"compositeSlicingAllowed":false,"imagegenAtlasAsSourceAllowed":false,"rigImplementationAllowed":false,"outfit2IntegrationAllowed":false,"classExpansionAllowed":false,"perPoseAssetsAllowed":false,"deformationAllowed":false,"animatedScaleAllowed":false}
```
...
**AUTHOR BODY-FIRST BẰNG SOURCE LAYER THẬT.** Board v6 chỉ khóa identity/silhouette. Tạo một source native có từng body part hoàn chỉnh, pivot và hidden cap được vẽ trong chính layer; mở lại được, body-only phải qua rotation board trước khi vẽ outfit. Sau đó outfit mới được author trực tiếp trên cùng bind source. Không cắt composite và không tách atlas ImageGen.
