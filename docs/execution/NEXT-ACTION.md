...
Scan remaining UI families for genuine density-profile candidates, prioritizing maintainability over cosmetic churn. Marker ready from the completed evidence refresh: `LGO_RUNTIME_UI_COMPONENT_DENSITY_EVIDENCE_REFRESH_READY`.
