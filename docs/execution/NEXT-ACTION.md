...
- Current reason: mobile Character Hall ready chips now read `Sẵn sàng` instead of repeating long lobby/character-ready copy; refreshed profile screenshots show cleaner header spacing in create and selected states, but no `VISUAL_RUNTIME_PASS` is claimed.
