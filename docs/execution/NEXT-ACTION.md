...
- Current reason: target-dummy HUD status now uses compact `Bia luyện: 108/120 sức bền mô phỏng.` style copy, reducing wrapped technical text across desktop/tablet/mobile evidence; runtime profile screenshots were reviewed, but no `VISUAL_RUNTIME_PASS` is claimed.
