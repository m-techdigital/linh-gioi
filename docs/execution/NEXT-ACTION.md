...
Refine Character Hall panel density and spacing after the latest screenshot review so character selection feels closer to the login polish level across desktop/tablet/mobile. Keep account/character semantics unchanged.
...
`LGO-LOGIN-PANEL-VISUAL-BALANCE-PASS-v1.0` is closed. Continue with `LGO-CHARACTER-HALL-PANEL-DENSITY-PASS-v1.0`.
