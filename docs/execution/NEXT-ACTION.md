...
Review and migrate stateless button construction after the primitive factory pass. Marker: `LGO_RUNTIME_UI_PRIMITIVE_FACTORY_READY`. Keep button behavior/action wiring explicit and do not move async/account/world state into the factory.
