...
Refresh world HUD/action shell runtime screenshots after the V3B skin pass. Review `world-hub`, `npc-dialogue`, `target-dummy-state`, and mobile/tablet profile screenshots for hierarchy, clipping, and scene readability.
...
`LGO-WORLD-HUD-ACTION-SHELL-V3B-SKIN-PASS-v1.0` is source-ready. Continue with world HUD/action shell evidence refresh, preserving current gameplay and contract semantics.
