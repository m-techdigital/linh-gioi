...
Verify all visual/evidence tooling writes to isolated paths and does not clobber current review output. Marker ready from the completed M5 evidence runner skin adoption: `LGO_M5_VISUAL_EVIDENCE_RUNNER_SKIN_ADOPTION_EVIDENCE_READY`.
