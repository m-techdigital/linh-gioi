...
- Base nhân vật chung 2026-09-08 theo owner: đã remake đầu–cổ–tóc Arrival từ seed giải phẫu CC0, fit scalp/tai, UV liên tục và weights qua neck_01; 12 phần áo, rest70bones và pixels2texture không đổi. Player105.350tri/57.808runtime vertices,1renderer/2material; build400.158.863B (+787.824B so a01b39c),0 lỗi/0 cảnh báo.2build/2capture,9/13frame1920×1080 đã xem tại `build/visual-evidence/arrival-anatomy-fixed-desktop/review.json`; có di chuyển thật và yaw chẩn đoán, không gameplay-camera/nhảy/FPS/mobile. Còn tóc mảng lớn, shading gáy, trang phục/biểu cảm chưa final. Thêm `client/art-source/common-human/HumanForms.blend`:18form nam/nữ × trẻ/trung niên/lớn tuổi × gầy/cân đối/đầy đặn,2family tóc tách riêng với18shape keys và binding bề mặt; cùng topology/source IDs/UV/mốc khớp, không phụ thuộc bộ áo.3 bảng đã xem tại `build/asset-staging/common-human-forms-verified/review.json`; base chưa rig/runtime/skin final và không vào build. `human_forms.py` là API chung; adapter Arrival vẫn migration một lần từ a01b39c có SHA guard. So bản tái dựng có sai khác khoảng1.8µm ở đầu, không claim binary-equivalent; master đã runtime-test là source chính. NEXT theo owner: tích hợp thực tế base nữ trẻ và nam lớn tuổi theo roster/storyboard, chuẩn hóa rig/nối cổ/tóc–trang phục dùng chung trên cả hai rồi kiểm tra pose/motion; Thanh Huyền identity riêng, không clone Keeper, không tiếp chỉ chỉnh một mặt hay một áo. Giữ5Lộ và kịch bản gốc; không mở reward/combat/frozen.

- Bộ prop sinh hoạt2026-09-08: CityEverydayProps thay cả bộ trà (ấm có vòi thông/nắp/quai,4chén rỗng/đĩa/khay) và dụng cụ nghề (búa/đục/kìm,ê-tô hai má/vít/tay vặn,phôi facet). Build399.371.039B (+8.788B),0 lỗi/0 cảnh báo incremental;7frame capture, đã xem5 góc liên quan tại `build/visual-evidence/everyday-props-verified-desktop/review.json`, tuyến xem/đóng/mở/đi tiếp qua. City1.406.940tri (+6.312),16batch (+3),không texture mới.2build/3capture, giữ lỗi bevel/phôi lượt đầu và một lượt Player thoát trước ảnh; lượt cuối xác minh. Chưa art final toàn quảng trường/FPS/mobile. OWNER tiếp2026-09-08: sau phần quảng trường chuyển phát triển NPC/player/tuyến nhân vật; ưu tiên mặt/giới tính/hình thể, đi/chạy/nhảy và trang phục theo mẫu final, xử lý theo bộ macro + rig/slot dùng chung. NEXT: kiểm tra master ArrivalWardrobe/KeeperWardrobe và mẫu từng identity, remake cả đầu–cổ–tóc/hình thể sai lệch trước rồi kiểm chứng pose/motion; Thanh Huyền riêng theo storyboard05, không clone Keeper hoặc tiếp thêm panel chữ.

- Khám phá quảng trường2026-09-08: trà đình/gian nghề có Xem/F, focus tại chỗ, góc nhìn đồ vật và panel bên trái PC dùng chung; đọc thêm/đóng/Escape trả điều khiển, tùy chọn trước Đá Luyện và không bypass tiến trình. Build399.362.251B (+10.989B),0 lỗi/18 cảnh báo;7 ảnh1920×1080 đã xem tại `build/visual-evidence/square-place-view-desktop/review.json`.3 build/3 capture; giữ lỗi test mở lại cùng frame và panel dùng nhầm inset căn giữa. Không thêm texture/model, chưa FPS/RAM/mobile hoặc legacy full regression. Chưa Thanh Huyền/dân cư/ngồi/uống trà/chế tạo; cận cảnh lộ ấm chén đặc/dụng cụ vuông lặp. NEXT: macro tạo hình bộ prop sinh hoạt (ấm có vòi/nắp, chén rỗng, dụng cụ có cấu tạo) theo demo và kit chung, rồi Thanh Huyền riêng theo storyboard05; không tiếp thêm panel chữ thay hoạt động.
...
- Cảnh quan quảng trường2026-09-08 theo owner: nhà theo cungR26m quay hiên vào tâm, sân thoáng và Keeper hết bị nhà che; thêm bộ hiên/lan can/bồn cây–hoa, chi tiết trà đình/bộ trà và trời mây. Đá6.5m đổi cả lõi thuôn/khung rẽ nhánh/bệ khảm, dấu xoắn bám facet.10 ảnh1920×1080 đã xem `build/visual-evidence/square-garden-sky-desktop/review.json`; tuyến thoại/chạm/pulse/hồi/không lặp/đi vòng tới trà qua. Build399.340.955B (+18.232B so040e079),0 lỗi/0 cảnh báo incremental. Landmark2.120tri/4mat; city kit1.038.456tri (+233.256),11batch vật liệu, không texture mới; chưa FPS/RAM/mobile. Hai macro (đá/cảnh quan), mỗi macro2 build/2 capture do sửa lỗi mới thật, giữ evidence dấu chìm và trời kéo vệt. Chưa final: nhà/tháp lặp, hoa lá đơn giản, thiếu dân cư/Thanh Huyền/hoạt động trà/nối thành. NEXT: tiếp cụm sinh hoạt và biến thể kiến trúc/cây theo design, gắn với kịch bản SCN002v0.2; reuse CitySquareDetails, không chuỗi chỉnh hệ số nhỏ. Mở candidate bằng `python3.12 tools/preview_training_square.py`; phố cũ giữ riêng. Ghi chú này là hướng hiện tại thay NEXT lịch sử bên dưới.
...
- Owner đổi hướng2026-09-08: phố hiện tại không phù hợp đặt Đá Luyện, giữ để reuse tuyến nhập thành/map khác. Đã thiết kế lại quảng trường40×48m và landmark khoảng6.5m theo sheet03, có vòng đi/điểm chạm thấp/trà đình/gian nghề. Xem `docs/design/linh-thanh-training-square/DESIGN.md` và `docs/story/scenarios/SCN-002-TRAINING-SQUARE-v0.2.md`; đây là DRAFT, chưa runtime. SCN002v0.2 là hướng thiết kế tiếp theo, thay giả định đá nhỏ bên phố củav0.1 cho batch mới. NEXT: dựng macro cả quảng trường+landmark+camera+tuyến chạm theo demo/mặt bằng, giữ phố cũ; không tiếp polish đá nhỏ. Shader thử chưa kiểm chứng đã cất `build/asset-staging/stone-surface-paused/`, runtime source không đổi trong batch thiết kế. Buff/reward/minigame/sự kiện có hướng thiết kế riêng, chưa mở cơ chế/frozen.

- Đá Luyện2026-09-08: cả cụm giá đồng cánh liền/bệ khảm/tinh thể phụ + pulse vật liệu;1.504tri/4material/không texture mới, giữ thấp1.1m/collider. Build399.276.994B (+6.759B),0 lỗi/19 cảnh báo;6 ảnh1920×1080 đã xem `build/visual-evidence/stone-cradle-road-desktop/review.json`, pulse/settle/repeat/đi ra qua. Giữ3 evidence lỗi (NaN, thời điểm đo LateUpdate, camera trong nhà);5 build/4 capture, chưa workflow tối ưu. Chưa final: lõi/đồng còn phẳng và hình học, pulse nhìn nhẹ. NEXT: hoàn thiện tổng thể chất liệu và hình dáng bộ prop mẫu theo sheet03 trong master chỉnh sửa được, preview đầy đủ trước tích hợp; không chuỗi đổi hệ số riêng. ScopeSCN002 vẫn thấp/gần gũi, không đài6.5m/buff/reward.

- Fit bộ player2026-09-08: vạt theo envelope quần, lining liền mép dùng chung weights, giáp tay/găng gọn hơn, gốc choàng fit bề mặt áo + nội suy weights tam giác.90.528tri/49.866runtime vertices (−1.800/−937),70bones/9slots/1renderer/2materials; build399.270.235B (−93.264B),0 lỗi/0 cảnh báo incremental.7 ảnh1920×1080 đã xem tại `arrival-fit-bound-desktop/review.json`; giữ3 bản lỗi liên quan, không claim final. Còn cổ/tóc/găng/mép vai và vạt nâng gối; chưa cloth collision/FPS/mobile. NEXT: đánh giá player–NPC–Linh Thành trong camera gameplay theo demo final và xử lý sai lệch macro lớn nhất của cả cảnh; không tiếp chuỗi thay hệ số vạt/cape riêng. Master là source chỉnh tiếp; fit_arrival_wardrobe.py chỉ migrate16846a8 có SHA guard. Preview đã thêm góc sau idle/jog, dùng --views cho góc cụ thể.

- Player wardrobe/drapery2026-09-08: master14 món/9slots, vai cong/vạt ngắn/choàng từ kit Keeper; thêm5 khớp vải ngoài65 xương Humanoid,1renderer/2materials/atlas giữ nguyên. Choàng rủ/cong khi chạy thay tấm cứng; vạt nâng gối còn phồng, cổ/tay/điểm nối choàng chưa final. Build399.363.499B,0 lỗi/18 cảnh báo cũ;7 ảnh1920×1080 đã xem tại `arrival-drape-desktop/review.json`. Toàn batch so e2f0282: +538.052B/+10.486tri; riêng5 khớp so arrival-stride:+7.848B, không thêm geometry/texture. Đã đưa17 tư thế Humanoid thực vào Blender preview (khớp rest rig sai số5.72e-7), chỉ1 lượt build/capture Player cho cơ chế vải sau preview. NEXT: art pass tổng thể player theo storyboard, trọng tâm phom lớp áo/tiếp giáp/cổ/tay và vạt khi nâng gối; dùng master và thư viện chuyển động này, không quay lại vá trên mesh ghép hoặc chỉ chỉnh hệ số cape. Chưa NPC nhiều người/FPS/mobile/cloth collision; chưa nhân rộng trước bộ mẫu đạt.

- Chất liệu2026-09-08: relief hoa văn vàng dùng chung NPC/player, nền vải smoothness0.10; normal2048×1024 BC7/PNG248.432B, thêm2.807.409B vào build398.825.447B; không thêm geometry/renderer. Build0 lỗi,8 ảnh1920×1080 đã xem tại `wardrobe-relief-desktop/review.json`. Hiệu quả chất liệu vừa phải, không thay phom và không phải sculpt high-low bake. NEXT: quay lại macro bộ mẫu/player/map theo reference; không tiếp vi chỉnh bump/roughness hoặc rerun cùng gate. Còn cape/giáp tay, phom cổ/thân/tóc/tay; chưa FPS/mobile. Khi đổi atlas, bake lại cả surface mask và relief rồi WardrobeSurfaceImporter.Apply.

- Upper wardrobe2026-09-08: cả cụm vai cong3 tầng/tay áo/cape liền và nối dưới đai; master14objects,74.043tri/40.995runtime vertices (−586),65bones/10slots/1renderer/2materials/atlas giữ nguyên. Build396.018.038B (−45.501B),0 lỗi;6 ảnh NPC actual1920×1080 đã xem tại `upper-envelope-desktop/review.json`. Giữ3 lượt lỗi, không claim final: cape/giáp tay còn chạm, phom cổ/thân/tóc/tay còn xa sheet; preview stride còn va chạm lớp. NEXT: hoàn thiện bộ mẫu theo silhouette/tiếp giáp chung và surface bake trước nhân rộng; không tiếp chuỗi thử nới cape riêng. Export trực tiếp master, --joined-source tạo flat dẫn xuất.

- Wardrobe2026-09-08: Keeper có master13 phần chỉnh riêng, ba vạt áo liền; sửa đảo trọng số đùi gây bật mảng trắng trước hông. Preview Blender5 tư thế, đã xem2 động tác; build396.063.539B/0 lỗi,6 ảnh NPC runtime đã xem (thực960×540, chưa full1920).73.815tri/41.581runtime vertices,65bones/10slots/1renderer/2materials; giữ atlas. Evidence `build/visual-evidence/authored-support-desktop/review.json`, giữ hai bản lỗi. NEXT: xác định capture full-resolution và hoàn thiện trọn thân/vai/cape trên `KeeperWardrobe.blend` theo sheet trước nhân rộng; preview bằng `tools/art/preview_wardrobe.py`, không tiếp chuỗi vá nhỏ/build. Chưa final/normal bake/FPS/mobile.

- Ensemble2026-09-08: cả cụm vai xếp lớp/đai chạm nổi/vạt hông/dây bội cho Keeper và player, giữ65bones/1renderer/2materials/atlas;10/8slots. Build396.170.627B (+1.169.857B),0 lỗi,8 ảnh cận và3 frame gameplay đã xem tại `ensemble-solid-desktop/review.json`, `ensemble-city-desktop/review.json`; giữ bản lỗi `ensemble-macro-desktop`. Chưa final, vai còn góc cạnh; không tiếp nắn từng viền. Owner yêu cầu đánh giá hiệu quả: cách nhiều script vá mesh chưa tối ưu. NEXT: dựng từng món trang phục hoàn chỉnh trong Blender với phom/nếp rủ theo sheet; dùng high/low bake cho chi tiết nhỏ, transfer rig chung, preview trọn bộ trước import Unity. Thử và đo một bộ trước nhân rộng5class/NPC; không claim nhanh hơn khi chưa benchmark. Tham khảo Blender Render Baking/Data Transfer và Epic Modular Characters; giữ frozen/SCN.

- Trang phục2026-09-08: thay projection tà áo/giáp tay bằng UV và hoa văn riêng dùng chung NPC/player, quần navy sạch và tà trước liền ghép dưới đai; +384tri mỗi actor, giữ65bones/9–7slots/1renderer/2materials/atlas4096×2048. Build395000770B,0 lỗi;8 ảnh runtime đã xem tại `build/visual-evidence/robe-fabric-desktop/review.json`, chưa art final. Owner nhắc đúng: batch đã lặp vi chỉnh/capture quá nhiều. NEXT: dừng polish riêng tà/viền; xử lý trọn ngoại hình theo demo (tỷ lệ, lớp áo, giáp, phụ kiện) trước một lượt review tổng thể, chỉ re-test lỗi cụ thể; không thêm docs/validator làm sản phẩm chính.

- Cape/vai2026-09-08: gốc cape phủ rộng/liền sau vai, fit theo body và blend clavicle; mảng trắng lớn phía trên đã che trong6 góc NPC idle/guide/return đã xem. Giữ62.017tris/35.844runtime vertices/65bones/9slots/1renderer/2materials/atlas; build395.012.306B (-1B),0 lỗi/0 cảnh báo lượt incremental. Evidence `build/visual-evidence/cape-mantle-desktop/review.json`. Chưa final: khe nhỏ mép gần tay, tà áo/giáp tay còn projection cũ. NEXT: macro lớp tà áo và giáp tay theo canonical sheet, giữ công thức slot chung; kiểm tra cả cụm sau visual delta, không tiếp polish riêng root cape. Chưa mọi locomotion/FPS/mobile; giữSCN/5Lộ/frozen.

- Áo/bóng đổ 2026-09-08: làm mềm thân/tay áo, lưng ivory riêng và nội suy skin cho1.170 vertices viền tay; giữ triangles/65bones/atlas/material. A/B xác nhận sọc chéo lưng do self-shadow, không phải texture;4cascades trong atlas2048 sửa sọc và giữ bóng thật. Runtime vertices35.844/40.264; build395.012.307B (+1.280B),0 lỗi/18 cảnh báoCS0618 UI cũ. Đã xem8 ảnh `cloth-cascades-desktop/review.json` và3 góc gameplay thành `cloth-cascades-city-desktop/review.json`; route hoàn tất9frames/locomotion, runner cũ assert7 đã audit theo contract9, không rerun. Chưa final/FPS/mobile;4cascades có thêm công render shadow, không claim miễn phí. NEXT: sửa cả cụm root cape/nối vai theo sheet để hết mảng vải trắng xuyên mép cape; không tiếp nắn mesh vì lỗi shadow. Giữ5Lộ/SCN/frozen.

- Trang phục 2026-09-08: UV/vải riêng cho thân và tay áo, dải chéo navy/vàng; đai–viền tay bám bề mặt mesh và hai khóa 3D, dùng chung Keeper/player. Giữ atlas4096×2048,65bones,1renderer/2materials,9/7slots; runtime vertices35.840/40.260. Import/build cloth-envelope qua395.011.027B (+499.777B),0 lỗi/0 cảnh báo;8 ảnh `build/visual-evidence/cloth-envelope-desktop/review.json` đã xem. Giữ evidence3 lượt visual chưa đạt trước đó. Chưa final: áo ôm cơ thể, nối tay–giáp/vai–cape thô, lưng player còn dải chéo trước. NEXT: macro hình khối áo/nếp rủ và các đường nối theo sheet, sửa cả cụm trước capture; không tiếp chuỗi tăng bóng/chỉnh màu. Chưa FPS/mobile, giữ5Lộ/SCN/frozen scope.

- Chất liệu2026-09-08: hoa văn giáp vai riêng512px/UV dome trong atlas chung; mask metallic/smoothness1024×512 BC7 tách vàng và vải, dùng chung NPC/player. Không thêm geometry/material, runtime vertices33.185/37.557; build394.511.250B (+761.312B),0 lỗi/0 cảnh báo.8 ảnh `wardrobe-surface-desktop/review.json` đã xem, highlight vàng hiện thật; atlas ngoài ô giáp giữ nguyên. NEXT: bề mặt áo/ngực và dưới giáp vai còn projection cũ, cần UV/vải riêng theo sheet và bake lại mask, không tiếp tăng độ bóng. Chưa art final/FPS/mobile; giữ5Lộ/SCN/frozen scope.

- Giáp vai/cổ2026-09-08: đổi chỏm tròn thành bản giáp vươn, nâng nhẹ nếp V; giáp cứng theo clavicle hiện có để tay chỉ hướng không dựng giáp sát nón. Áp dụng Keeper/player, giữ geometry count/65bones/slots/material/texture. Build393.749.938B/0 lỗi/0 cảnh báo;8 ảnh `upper-armor-clavicle-desktop/review.json` đã xem. Bản vươn quá lớn/theo upperarm lưu FIX_REQUIRED tại `upper-armor-desktop/review.json`. Chưa final: texture vai/ngực/cổ vẫn mảng kéo/phẳng. NEXT: macro bề mặt trang phục thân trên theo sheet, dùng UV/material riêng cho áo–giáp trong atlas chung, tránh tiếp chỉ nắn silhouette. Chỉ test phần thay; giữ5Lộ/SCN/frozen scope.

- Ủng dùng chung 2026-09-08: tile da navy/viền vàng riêng 512px đặt trong atlas hiện có, UV trụ thay donor kéo sọc; vỏ giày liền thay ngón chân cho cả Keeper/player. Giữ 65 bones, 1 renderer/2 materials, 9/7 slots. Import/build cuối `boot-instep-*` qua: 393.749.939B, 0 lỗi/0 cảnh báo, giảm162.880B so checkpoint trước; runtime vertices33.507/37.879. Đã xem8 ảnh tại `build/visual-evidence/boot-instep-desktop/review.json`; giữ3 lượt visual lỗi trước. Chưa art final, chưa locomotion/FPS/mobile. NEXT: macro giáp vai–ngực–cổ theo sheet canonical, sửa hình khối và bề mặt cùng batch trước capture; không tiếp chuỗi polish giày, giữ5Lộ/SCN/frozen scope.
...
- NPC macro2026-09-08: nón kín có đỉnh/viền/phù rủ; tà áo liền và bớt lõm, lùi đều phần dưới để hết giao ủng trong góc nghiêng đã chụp; thêm hint khuỷu phải giữ hướng gập khi chỉ đường. Giữ9slots/65bones/1renderer/2materials, không thêm texture. Import `keeper-drape-clearance-import.log` và build `keeper-drape-clearance-build.log` qua393.318.375B/0 lỗi/0 cảnh báo;8 ảnh PC đã xem tại `build/visual-evidence/keeper-drape-clearance-desktop/review.json`. Giữ evidence bản lỗi ở `keeper-hat-drape-desktop/review.json` và log import vượt chiều cao; không nới guard. Chưa final: chóp/hoa văn nón, tay nắm/giáp vai, texture ủng; chưa xác nhận đi/chạy/cloth. NEXT: macro đầu/nón/vai/bàn tay và texture ủng theo canonical sheet; giữ thành cổ kính và5Lộ, không mở frozen scope. Chỉ test phần thay.

- Ánh sáng/chiều sâu 2026-09-08: chuyển ambient sang trời/ngang/đất, nắng hơi ấm; fog tuyến tính36–170m tách lớp phố xa và giữ tuyến gần rõ. Bản đầu fog không hiện trong Player, đã sửa GraphicsSettings fog stripping automatic→custom để giữ fog modes tick sẵn; evidence lỗi `city-daylight-depth-desktop/review.json`. Build cuối `city-daylight-fog-build.log`393.158.395B/0 lỗi/0 cảnh báo incremental (đầu19 cảnh báo);9 ảnh PC đã xem tại `build/visual-evidence/city-daylight-fog-desktop/review.json`, fog hiện thật, route/camera/presentation qua. Không thêm geometry/texture; build tăng81.384B, chưa đo FPS. OnDisable phục hồi các RenderSettings đã đổi; lifecycle restore mới source review, không claim test riêng. Chưa final: cây/cổng/vật liệu còn thô; NEXT quay lại macro NPC tay/nón/tà áo theo phản hồi owner và canonical sheet, kiểm tra chuyển động đúng phần sửa, tránh thêm cảnh vô hạn.

- Lớp phố xa 2026-09-08: thêm27 lầu 3D theo3 lớp cao thấp sau cổng; reuse khung/ban công/mái của Tower hiện có, có nền/móng, không collider/gameplay mới. Camera far80→145. Review đầu loại nhà hộp đơn giản vì lệch family; evidence `city-skyline-desktop/review.json`. Bản cuối `city-skyline-grounded-build.log`393.077.011B/0 lỗi/0 cảnh báo incremental (đầu18 cảnh báo);9 ảnh PC đã xem tại `build/visual-evidence/city-skyline-grounded-desktop/review.json`, route/camera/presentation qua. Tổng943.460tri (+231.888), không texture/material mới; chưa đo FPS/RAM. Chưa final: lầu lặp, tương phản xa/gần chưa tách, cổng và vật liệu còn phẳng. NEXT: macro ánh sáng/chiều sâu không khí cho toàn cảnh sáng thân thiện theo North Star, kiểm tra bóng/khả năng đọc NPC và đường; không nhân thêm nhà chỉ để tăng số lượng.

- Bộ đá kiến trúc 2026-09-08: trụ cổng có chân/mũ, tường sân có mạch đá/trụ/chóp và viền bồn/chân nhà dùng cùng family runtime. Giữ collider gốc; geometry trang trí không collision. Review đầu bắt khe xuyên sáng/pattern gạch quá nhỏ, đã sửa lõi kín và vật liệu hạt chung; evidence lỗi giữ `city-masonry-desktop/review.json`. Build cuối `city-masonry-solid-build.log`393.075.635B/0 lỗi/0 cảnh báo incremental (đầu19 cảnh báo);9 ảnh PC1920×1080 đã xem ở `build/visual-evidence/city-masonry-solid-desktop/review.json`, đi sân/quay lại/camera/presentation qua. Tăng6.564tri và2 material chung, không texture mới; chưa đo FPS/RAM. Chưa final: đá đều/cạnh vuông, cảnh xa thưa và cổng xa phẳng. NEXT: macro lớp nhà/cảnh xa bám demo để giảm skyline trống; tránh tiếp chuỗi vi chỉnh đá và rerun phần không đổi.

- Vườn 3D 2026-09-08: thông sân đã thay sprite bằng thân/cành/rễ/lá kim 3D và bóng thật; vườn hoa có cành cong/cụm cánh và biến thiên tán. Giữ collider/lối đi. Build `city-garden-rooted-build.log`393.072.790B/0 lỗi/0 cảnh báo incremental; runtime `city-garden-rooted-desktop.log` qua assertions chân cây/thể tích/collider, đi sân/quay lại/camera. Đã xem9 ảnh PC1920×1080 tại `build/visual-evidence/city-garden-rooted-desktop/review.json`; bản đầu FIX_REQUIRED được giữ. Chưa final: tán/cành còn hình học/lặp, tường/bệ/cảnh xa sơ sài, UV xà còn kéo. Cảnh+cây705.008 tam giác so339.536 trước, không thêm texture; chưa đo FPS/RAM/mobile. NEXT: macro tường/bệ và lớp cảnh xa theo demo, giữ chất cổ kính và5Lộ; không rerun test nhân vật/thoại không đổi.

- Chất liệu phố 2026-09-08: đưa hai albedo riêng vào runtime—đá lát có mép mòn/mạch không đều và gỗ sẫm cho nhà/lan can/đình. Không crop board; provenance `client/art-source/linh-thanh-kit/surface-provenance.json`. Import `city-albedo-import.log` xác nhận1024×1024 BC7/11mips/Repeat/non-readable; build `city-albedo-build.log`393.067.883B/0 lỗi/19 cảnh báo, tăng2.797.112B cho hai texture chung. Bảy ảnh PC1920×1080 đã xem tại `build/visual-evidence/city-albedo-desktop/`, đi sân/quay lại và camera assertions qua. Geometry/collider không đổi. Chưa final: thớ gỗ xà ngang bị kéo UV, đá chưa relief, tường/bệ và cây/cảnh xa còn sơ sài. NEXT: macro tường/bệ đá và cây/cảnh xa theo demo, UV vật liệu theo chiều thanh; không tiếp rerun test phần không đổi.
...
- Checkpoint mặt/tóc player và phố cổ 2026-09-08: đầu kín, face riêng 1774×887, tóc buộc cao; khép khe cổ áo phát hiện trong runtime bằng 88 tam giác nối trực tiếp, skin đuôi tóc theo Head/cổ/thân. Giữ 7 slot, 1 renderer/2 material, body atlas chung; 68.026 tam giác/38.343 vertex Unity. Tests `player-neck-final-tests.xml` 5/5; build `player-neck-final-build.log` 390.264.503 B, 0 lỗi/19 cảnh báo. Đã xem 13 ảnh PC 1920×1080 tại `build/visual-evidence/player-neck-final-desktop/`, gồm đi/quay và hai pose chẩn đoán xoay đầu ±40°; không phải gameplay talking mới. Ảnh lỗi cũ giữ tại `player-face-hair-desktop/review.json`. Kit nhà/café/cổng có cửa song, gỗ sẫm, bệ đá, hiên sâu và ngói xếp lớp theo demo; ba draft tại `docs/art/preproduction/`, 9 material chung, chưa runtime adapter. Chưa art final: tóc dạng khối, UV cổ/lưng/quần kéo/lặp, bóng mặt có dải; phố còn thiếu mật độ/sinh hoạt. NEXT: macro chất liệu/UV theo demo và family phố cổ/café vào cảnh candidate bám bố cục gốc, sau đó bộ Võ/NPC đời thường. Giữ đủ 5 Lộ và frozen scope; không coi bản ghép đơn giản là final.

- Checkpoint player + chuẩn bị nội dung 2026-09-08: player remake áo/tay/quần/găng/ủng liền hơn, tóc buộc cao; sửa lỗ sau đầu/gáy và mép eo sau review thật. Cùng baker/Avatar với Keeper,7 slot tác giả →1 renderer/2 material,33.255tri/20.622vertex Unity,không texture mới. Tests `player-closed-head-tests.xml`5/5; build `player-closed-head-build.log`382.202.499B/0 lỗi/0 cảnh báo;7 ảnh PC1920×1080 đã xem tại `build/visual-evidence/player-closed-head-desktop/`, có đi/quay thật. Chưa art final: mặt nghiêng/cổ nhọn, tóc cứng, UV quần/lưng còn lặp. Theo owner mới, phân tích đầy đủ5 Lộ Võ/Kiếm/Pháp/Cơ/Linh,4 map GDD,item/skill/linh thú/sự kiện tại `docs/art/preproduction/LGO-CONTENT-ASSET-DIRECTION.md`; catalog10 hướng class/NPC là design-only. Kit phố9module/9material,3layout Blender có café/nhà cao-thấp/chợ, chưa runtime adapter. NEXT: macro mặt/cổ và fit trang phục dựa design gốc; chọn bộ Võ hoặc NPC đời thường để mở rộng ngoài Keeper, tích hợp café bằng family chung sau duyệt hình khối. Giữ đủ5 hướng thiết kế, không đồng nhất tu tiên; chỉ kiểm tra phần vừa đổi sau macro, không mở frozen/gameplay mới từ ảnh.
...
- Cảnh Linh Thành: cụm cổng/tháp nay có sân lát, vườn thấp/cây và hành lang mái hai bên thay nền trống; giữ cấu trúc tầng gỗ/mái che phố của batch trước. Kit86.928tri/8 material/ba texture nhỏ, không mở vùng đi lại/collider mới. Build `city-gardens-build.log` thành công343.470.633B/0 lỗi/19 cảnh báo; quick `city-gardens-quick.log`, Player toàn tuyến và wrapper exit0. Ảnh street-outlook/forecourt đã xem tại `build/visual-evidence/onboarding-blockout/city-gardens-mobile/`; PNG gồm960×540 và3024×1898 dù tên/profile mobile, dimensions lưu `city-gardens-capture-dimensions.json`, không claim mobile viewport/device. NEXT: bổ sung nhịp sinh hoạt nhẹ ở sân theo phần đời sống Linh Thành của board, dùng nhân vật/rig/appearance chung để kiểm chứng tái sử dụng; không mở chat/quest/reward hoặc đổi frozen surfaces. Cảnh vẫn candidate, chưa art final/FPS target.

- Checkpoint macro cảnh Linh Thành theo owner: player trẻ gọn hơn, áo navy/ngà và tóc dài; dùng shared appearance/rig/controller/texture Keeper, asset riêng ~398KB trong build. Đá Luyện pha lê xanh/bệ đá–đồng296tri, không texture riêng. Phố có mái cong/khung gỗ/cờ/cổng vòm/tháp, kit8 material/129.048tri và texture gỗ64×64; collision tuyến cũ giữ nguyên. Build `city-macro-final-build.log` thành công343.465.563B (giảm1.413.712B so keeper tối ưu),0 lỗi/19 cảnh báo; không claim build sạch warning.23/23 `city-macro-final-tests.xml`, full-route `city-macro-final-mobile.log`, quick `city-macro-final-quick.log` qua; ảnh đã xem. Sửa source hai mặt áo tự giao, reimport cuối không còn discarded polygon; sửa mái/facade xoay lệch và gân mái nổi. Video runtime8s: `build/visual-evidence/city-macro-final-video/linh-thanh-ro-net-8s.mp4`. Chưa art final/FPS điện thoại/cảnh đông: tường/tháp còn đơn giản, cây hoa còn khối, mặt/tóc và mép áo cần art pass. NEXT: dùng checkpoint này để review độ gần design; tiếp macro chất liệu/kiến trúc và foliage theo board, giảm kit geometry theo khoảng cách, đo trên target trước mở rộng số lượng. Không đổi frozen surfaces.

- Checkpoint tối ưu keeper/NPC: giữ ngoại hình remake, sửa nón/cape kéo theo tay và thu gọn tà; 24.400 triangles, 65 bones. Tách semantic nón/đầu-tóc/thân-trang phục ở source; ghép sẵn một mesh nén Medium, hai material và preset dùng chung. Mesh trong build ~506 KB, toàn bộ asset keeper riêng ~1 MB, preset tham chiếu ~1,1 KB; game 352.010.691 → 344.879.275 bytes. 22/22 tests `keeper-optimized-verified-tests.xml`, build 0 lỗi/0 cảnh báo, toàn tuyến960x540 `keeper-optimized-verified-mobile.log`, quick `keeper-optimized-quick.log` qua; ảnh đã xem. Không còn mảng cape lớn kéo tới tay trong pose đã review; mép vải/hoa văn chưa art final. Video trước: `build/visual-evidence/keeper-before-optimization/nguoi-giu-cong-8s.mp4`; video cuối8s đã xuất và xem ở `build/visual-evidence/keeper-optimized-verified-video/nguoi-giu-cong-toi-uu-8s.mp4`. NEXT theo owner: macro pass nhân vật người chơi, Đá Luyện và Linh Thành theo cảnh reference v4, tích hợp rồi capture chung để đánh giá chất lượng/dung lượng; chưa claim mọi bộ dưới100KB hoặc FPS điện thoại/cảnh đông. Không đổi frozen surfaces.
