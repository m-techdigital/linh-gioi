...
- Current reason: local combat CTA width metrics now give `Tấn công thử` / `Hồi chiêu` enough room in the World HUD; runtime screenshot evidence was reviewed, but no `VISUAL_RUNTIME_PASS` is claimed.
