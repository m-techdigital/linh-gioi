...
- Current reason: skill preview buttons now use compact skill-specific metrics so all three preview actions fit as one readable row in the World HUD; runtime screenshot evidence was reviewed, but no `VISUAL_RUNTIME_PASS` is claimed.
