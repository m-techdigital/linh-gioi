...
```json
{"activeTask":"LGO_RIGID_OUTFIT_PILOT_01","phase":"FINAL_OUTFIT1_CANONICAL_BIND_REGISTRATION","status":"CONTINUE","method":"DESIGN_FIRST_NATIVE_LAYERED_RIGID_AUTHORING","sourceProfile":"lgo_character_canvas_1024x1536_v1","requiredMotion":["Idle","Walk","Run","Jump","Attack","Roll"],"motionAuthority":"build/character-base-v3/male-old-base-six-pose-reference.png","currentDesignEvidence":"build/rigid-outfit-pilot/final-1-coherent-body-design-v9/canonical-bind-profile-v1/male-female-canonical-bind-review-v1.png","jointContract":"docs/art/LGO-RIGID-JOINT-AND-LAYER-AUTHORING-CONTRACT-v1.md","jointProfile":"docs/art/data/lgo-rigid-joint-interface-profile-v1.json","moduleTopology":"build/rigid-outfit-pilot/final-1-three-quarter-design-v5/outfit-module-topology-v2.json","rejectedSourceEvidence":["build/rigid-outfit-pilot/rejected-iterations/v7-composite-mask-source","build/rigid-outfit-pilot/rejected-iterations/v7-imagegen-atlas-invalid","build/rigid-outfit-pilot/rejected-iterations/v8-procedural-primitive-body-source"],"currentSourceAuthorityValid":false,"bodyBindCalibrated":false,"technicalInvariantStatus":"CANONICAL_REGISTRATION_TESTS_PASS_NATIVE_LAYER_SOURCE_MISSING","visualStatus":"V9_COHERENT_BIND_AND_LANDMARK_MAP_REVIEW_READY","stopCondition":"NATIVE_LAYERED_BODY_SOURCE_REQUIRED","bodyModuleCount":16,"outfitModuleCount":25,"redesignOutfit1Allowed":true,"nativeLayerAuthoringAllowed":true,"proceduralPrimitiveBodyAllowed":false,"compositeSlicingAllowed":false,"imagegenAtlasAsSourceAllowed":false,"rigImplementationAllowed":false,"outfit2IntegrationAllowed":false,"classExpansionAllowed":false,"perPoseAssetsAllowed":false,"deformationAllowed":false,"animatedScaleAllowed":false,"canonicalBindProfileEvidence":"build/rigid-outfit-pilot/final-1-coherent-body-design-v9/canonical-bind-profile-v1/canonical-bind-profile-v1.json"}
```
...
**AUTHOR BODY-FIRST BẰNG SOURCE LAYER THẬT TỪ DESIGN V9.** Dùng clean design v9 làm underlay reference và canonical landmark map làm guide. Trong Krita, vẽ từng body part hoàn chỉnh cùng hidden geometry ở chính layer, lưu/mở lại KRA và xuất RGBA common-canvas. Body-only phải qua rotation board trước khi vẽ outfit. Sau đó outfit mới được author trực tiếp trên cùng bind source. Không cắt composite và không tách atlas ImageGen.
