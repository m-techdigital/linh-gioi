...
Refresh desktop/tablet/mobile visual evidence after the runtime UI skin adoption series. Marker: `LGO_WORLD_HUD_STYLE_ADOPTION_READY`. Review Login, Character Hall, World Hub, NPC Dialogue, and Session Menu screenshots; do not claim visual PASS unless a human acceptance gate explicitly approves it.
