...
Improve mobile world hub framing so player, NPC, dummy, and key props read larger and clearer without changing gameplay semantics or adding assets. Preserve desktop/tablet composition.
...
`LGO-WORLD-HUD-ACTION-SHELL-EVIDENCE-REFRESH-v1.0` is evidence-ready. Continue with mobile world camera/framing polish, preserving current gameplay and contract semantics.
