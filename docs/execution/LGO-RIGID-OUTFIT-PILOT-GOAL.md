...
6. Không gọi một chuỗi state rời là Final. Final #1 bắt buộc có combo liên tục ở gameplay speed, transition được blend theo shortest rotation arc và board frame liền kề để phát hiện pop.
