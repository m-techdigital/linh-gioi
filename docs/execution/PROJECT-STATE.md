...
## Hiện hành — thu hồi visual pass sai và audit đúng actor source-pose — 2026-09-12
...
Next: re-author source mask của 7 pack fail theo design gốc, kiểm board full compose + tháo từng món + sáu pose ở kích thước lớn, sau đó capture đúng actor cho cả bốn class với chuyển giới/cấp/class trong cùng Player. Chỉ khi silhouette, độ nét, anatomy, bốn nhịp chạy và lộn đạt bằng mắt mới mở Player cho owner. Giữ Võ div4/base/tỷ lệ/camera và registered outfit; không tạo hệ song song, không sửa frozen surfaces.
