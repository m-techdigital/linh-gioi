...
Resume guard mới: `docs/execution/STOPPED-PATHS-AND-RESUME-GUARDS.md` khóa các vòng đã dừng để worker sau không mở lại bằng tên khác. Cấm tiếp tục skeletal generated-cutout hiện tại, flat 2D pattern/panel direct-fit như production, và chỉnh garment từng pixel không có source-space guide/gate. Muốn mở lại phải có proof gate rõ, evidence mới và điều kiện resume trong guard.
