...
- Linh Thành đã có hub shell, Quảng Trường shell, Học Viện shell, Thương Phố shell, Đền Linh shell, unlock presentation từ Đông Môn, board/NPC preview, target selector và label readability pass.
