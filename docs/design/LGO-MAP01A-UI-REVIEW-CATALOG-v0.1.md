...
| Character hub — Rương đồ | `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/bag.png` | Shared shell/layout evidence hiện hành; category rail dọc, grid và detail-right giữ cùng composition ở ba viewport. `SHARED_LAYOUT_PASS`; screen detail chờ sau Nhân vật. |
...
- Rương đồ: review `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/{bag,bag-search-binh-mau,bag-search-binh-mau-selected}.png`; category rail, grid và detail-right phải giữ cùng composition.
