...
| Character hub — Tiềm năng | `build/map01a-character-hub-potential-polish-runtime-v11/{pc,mobile,tablet}/{potential-default,potential}.png` | Một template tĩnh 600×520 dùng chung sở hữu vòng rune/đường nối/khung và quầng node/ô giá trị/ô cộng/lõi thiền/trục mạch; overlay chỉ bind icon/text/value/click và cùng object tree được giữ khi đổi class. Evidence đúng PC 1280×720, tablet 1024×768, mobile landscape 1600×720. Detail-right vẫn là một template dùng chung. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/map01a-character-hub-potential-polish-runtime-v11/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm vòng rune/lõi thiền/trục mạch, alignment icon/tên/value/add, detail hero/current level/current/next/cost và trạng thái tab chọn ở đúng ba viewport.
