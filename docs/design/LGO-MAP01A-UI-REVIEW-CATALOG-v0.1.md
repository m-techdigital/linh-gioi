...
- Inventory tab review frames: `build/map01a-inventory-tab-runtime/character-info.png` and `build/map01a-inventory-tab-runtime/storage.png`; these must show the Map01A inventory shell, not entry/login overlay.
