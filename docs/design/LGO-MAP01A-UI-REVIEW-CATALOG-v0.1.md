...
| Character hub — Kỹ năng | `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/{skills-default,skills}.png` | Shared shell/layout evidence hiện hành; rail, graph và detail-right giữ cùng composition ở ba viewport. `SHARED_LAYOUT_PASS`; screen detail chờ đúng thứ tự. |
...
- Kỹ năng: review `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/{skills-default,skills}.png`; rail, graph, equipped strip và detail-right phải giữ cùng composition.
