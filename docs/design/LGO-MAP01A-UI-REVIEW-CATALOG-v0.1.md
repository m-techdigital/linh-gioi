...
| Character hub — Tiềm năng | `build/character-hub-visual-hierarchy-runtime-v15/{pc,mobile,tablet}/{potential-default,potential}.png` | Một template tĩnh 600×520 dùng chung sở hữu vòng rune/đường nối/khung và quầng node/ô giá trị/ô cộng/lõi thiền/trục mạch; overlay chỉ bind icon/text/value/click. Shared inspector giữ hierarchy và cost/action không chồng ở PC 1280×720, tablet 1024×768, mobile landscape 1600×720. Catalog/state bất biến cho đủ năm class; không có layout theo class. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/character-hub-visual-hierarchy-runtime-v15/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm vòng rune/lõi thiền/trục mạch, alignment icon/tên/value/add, detail hero/current level/current/next/cost/action và trạng thái tab chọn ở đúng ba viewport.
