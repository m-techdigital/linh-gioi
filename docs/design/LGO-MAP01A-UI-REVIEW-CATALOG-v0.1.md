...
| Quest/HUD route | `build/map01a-world-view-capture-runtime-v3/01-arrival-q01.png`, `build/map01a-world-view-capture-runtime-v3/18-q09-portal-open.png`, and `build/map01a-world-view-capture-runtime-v3/manifest.json` | Current Q01–Q09 route evidence; 18 route frames, 38 dialogue frames, Q05–Q09 world view unobstructed, 1600×900 |
...
- Route start/end: `build/map01a-world-view-capture-runtime-v3/01-arrival-q01.png` and `build/map01a-world-view-capture-runtime-v3/18-q09-portal-open.png`.
