...
| Character hub — Linh thú | `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/spirit-pet.png` | Chrome v2 hiện hành; hero, progress, roster và inspector badge dùng chung modal/panel/tab skin. `OWNER_VISUAL_REVIEW_REQUIRED`; slot/action chưa có contract giữ khóa. |
...
- Linh thú: review `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/spirit-pet.png`; kiểm hero/progress/roster/detail và trạng thái tab chọn.
