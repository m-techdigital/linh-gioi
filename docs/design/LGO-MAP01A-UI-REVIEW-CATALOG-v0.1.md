...
| Character hub — Nhân vật | `build/map01a-character-inspector-runtime-v1/{pc,mobile,tablet}/{character-info,character-info-selected,character-info-locked}.png` | Screen evidence hiện hành; đủ 10 slot với level thật, identity/vitals, một detail-right và state mặc/chọn/khóa ở ba viewport. `LAYOUT_LOCKED`; actor/art dùng runtime source hiện hành theo contract. |
| Character hub — Rương đồ | `build/map01a-storage-layout-runtime-v1/{pc,mobile,tablet}/{bag,bag-search-binh-mau,bag-search-binh-mau-selected}.png` | Screen evidence hiện hành; rail dọc, grid 4×5, search/selection và detail ba action giữ cùng composition ở ba viewport. `LAYOUT_LOCKED`; ô trống/action chưa có contract giữ trạng thái trung thực. |
| Character hub — Kỹ năng | `build/map01a-skills-layout-runtime-v1/{pc,mobile,tablet}/{skills-default,skills}.png` | Screen evidence hiện hành; rail, graph ba hàng, bốn slot đánh số, điểm kỹ năng và detail-right giữ cùng composition ở ba viewport. `LAYOUT_LOCKED`; progression action giữ khóa. |
| Character hub — Tiềm năng | `build/map01a-potential-layout-runtime-v1/{pc,mobile,tablet}/{potential-default,potential}.png` | Screen evidence hiện hành; diagram năm node, core, footer và detail-right giữ cùng composition ở ba viewport. `LAYOUT_LOCKED`; progression action giữ khóa. |
| Character hub — Linh thú | `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/spirit-pet.png` | Shared shell/layout evidence hiện hành; hero, roster và detail-right giữ cùng composition ở ba viewport. `SHARED_LAYOUT_PASS`; screen detail chờ đúng thứ tự. |
...
- Nhân vật: review `build/map01a-character-inspector-runtime-v1/{pc,mobile,tablet}/{character-info,character-info-selected,character-info-locked}.png`; layout screen đã khóa, không mở lại nếu không có regression/evidence mới.
- Rương đồ: review `build/map01a-storage-layout-runtime-v1/{pc,mobile,tablet}/{bag,bag-search-binh-mau,bag-search-binh-mau-selected}.png`; layout screen đã khóa, không mở lại nếu không có regression/evidence mới.
- Kỹ năng: review `build/map01a-skills-layout-runtime-v1/{pc,mobile,tablet}/{skills-default,skills}.png`; layout screen đã khóa, không mở lại nếu không có regression/evidence mới.
- Tiềm năng: review `build/map01a-potential-layout-runtime-v1/{pc,mobile,tablet}/{potential-default,potential}.png`; layout screen đã khóa, không mở lại nếu không có regression/evidence mới.
- Linh thú: review `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/spirit-pet.png`; hero, progress, roster và detail-right phải giữ cùng composition.
