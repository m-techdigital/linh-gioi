...
| Character hub — Nhân vật | `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/character-info.png` | Shared shell/layout evidence hiện hành; năm tab compact, stage nhân vật + 10 slot và detail-right giữ cùng composition ở ba viewport. `SHARED_LAYOUT_PASS`; chi tiết screen vẫn `FIX_REQUIRED` và là screen active. |
...
- Nhân vật: review `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/character-info.png`; shared shell đã pass, screen detail vẫn active/FIX_REQUIRED.
