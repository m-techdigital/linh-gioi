...
| Character hub — Tiềm năng | `build/map01a-character-hub-potential-template-runtime-v9/{pc,mobile,tablet}/{potential-default,potential}.png` | Một template tĩnh 600×520 dùng chung sở hữu vòng/đường nối/khung node/ô giá trị/ô cộng/core figure/trục mạch; overlay chỉ bind icon/text/value/click và cùng object tree được giữ khi đổi class. Detail-right vẫn là một template dùng chung. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/map01a-character-hub-potential-template-runtime-v9/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm template topology/core/trục mạch, alignment icon/tên/value/add, detail hero/current level/current/next/cost và trạng thái tab chọn.
