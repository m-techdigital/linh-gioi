...
| Approved five-tab character hub | `build/map01a-character-vitals-runtime-v1/character-info.png`, `build/map01a-character-vitals-runtime-v1/bag.png`, `build/map01a-character-vitals-runtime-v1/bag-search-binh-mau.png`, `build/map01a-character-vitals-runtime-v1/bag-search-binh-mau-selected.png`, `build/map01a-character-vitals-runtime-v1/skills.png`, `build/map01a-character-vitals-runtime-v1/potential.png`, `build/map01a-character-vitals-runtime-v1/spirit-pet.png`, and `build/map01a-character-vitals-runtime-v1/manifest.json` | Current five-tab evidence; tab Nhân vật binds HP/MP thật vào shared status bars, Rương đồ giữ filtered count và selection-detail đồng bộ; `usesOsMouseOrKeyboard=false`, 1600×900 |
...
- Five approved tabs and search states: all seven PNGs under `build/map01a-character-vitals-runtime-v1/`; they must keep one compact navigation row, two content columns, HP/MP bars bound to current values, accurate search-result feedback and detail on the right.
