...
| Character hub — Tiềm năng | `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/{potential-default,potential}.png` | Shared shell/layout evidence hiện hành; diagram và detail-right giữ cùng composition ở ba viewport. `SHARED_LAYOUT_PASS`; screen detail chờ đúng thứ tự. |
...
- Tiềm năng: review `build/map01a-five-tab-layout-runtime-v4/{pc,mobile,tablet}/{potential-default,potential}.png`; diagram, footer và detail-right phải giữ cùng composition.
