...
| Character hub — Tiềm năng | `build/character-hub-potential-overlay-runtime-v16/{pc,mobile,tablet}/{potential-default,potential}.png` | Template tĩnh 600×520 sở hữu vòng rune/đường nối/một outer slot frame cho mỗi node/value/add frame/lõi thiền; overlay không có hình học, chỉ bind medallion icon/text/value/click. Shared inspector không chồng ở PC 1280×720, tablet 1024×768, mobile landscape 1600×720. Catalog/state bất biến cho đủ năm class; không có layout theo class. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/character-hub-potential-overlay-runtime-v16/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm outer slot frame/medallion icon, vòng rune/lõi thiền/trục mạch, alignment icon/tên/value/add, detail hero/current level/current/next/cost/action và trạng thái tab chọn.
