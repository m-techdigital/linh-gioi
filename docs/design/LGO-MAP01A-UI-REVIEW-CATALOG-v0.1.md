...
| Character hub — Tiềm năng | `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/{potential-default,potential}.png` | Chrome v2 hiện hành; diagram năm node, core, footer và detail-right giữ cùng composition. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm diagram/core/detail và trạng thái tab chọn.
