...
| Character hub — Linh thú | `build/map01a-spirit-layout-runtime-v1/{pc,mobile,tablet}/spirit-pet.png` | Screen evidence hiện hành; hero, progress, roster và inspector badge giữ cùng composition ở ba viewport. `LAYOUT_LOCKED`; slot/action chưa có contract giữ khóa. |
...
- Linh thú: review `build/map01a-spirit-layout-runtime-v1/{pc,mobile,tablet}/spirit-pet.png`; layout screen đã khóa, owner visual review là gate tiếp theo.
