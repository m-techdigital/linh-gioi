...
| Character hub — Tiềm năng | `build/map01a-character-hub-potential-class-default-runtime-v8/{pc,mobile,tablet}/{potential-default,potential}.png` | Một vector topology dùng chung sở hữu vòng/đường nối/khung node/ô giá trị/ô cộng/core figure/trường năng lượng/trục năm điểm mạch; một detail template dùng chung sở hữu hero summary/current level/current effect/next effect/cost. Class chỉ bind icon/text/value và node mặc định từ profile data. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Tiềm năng: review `build/map01a-character-hub-potential-class-default-runtime-v8/{pc,mobile,tablet}/{potential-default,potential}.png`; kiểm topology/core figure/trục năm điểm mạch, năm node/value/add, detail hero/current level/current/next/cost và trạng thái tab chọn.
