...
- Five approved tabs and search states: all seven PNGs under `build/map01a-search-count-runtime-v3/`; they must keep one compact navigation row, two content columns, accurate search-result feedback and detail on the right.
