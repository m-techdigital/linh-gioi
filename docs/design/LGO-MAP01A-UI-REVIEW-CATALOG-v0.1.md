...
| Character hub — Kỹ năng | `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/{skills-default,skills}.png` | Chrome v2 hiện hành; rail, graph, equipped strip và detail-right dùng chung modal/panel/tab skin. `OWNER_VISUAL_REVIEW_REQUIRED`; progression action giữ khóa. |
...
- Kỹ năng: review `build/map01a-five-tab-chrome-runtime-v3/{pc,mobile,tablet}/{skills-default,skills}.png`; kiểm rail/graph/equipped/detail và trạng thái tab chọn.
