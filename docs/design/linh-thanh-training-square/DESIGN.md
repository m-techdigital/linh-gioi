...
Rìa sân hiện có ba biến thể nhà qua `SquareResidence(style)`: nhà thấp, quầy hàng và nhà hai tầng; `House(upperStorey)` giữ mặc định cũ cho phố nhập thành. `CraftStall` và `SquareLantern` dùng cùng batch vật liệu. Gian nghề đặt(12,0,16), lùi khỏi bồn cây, có biển tên vật lý như trà đình; chưa có NPC/chế tạo. Hai tháp xa cùng mái công trình rộng thay hàng tháp dày của candidate trước.

Bộ thực vật của quảng trường dùng `CityGardenBotany`: mesh riêng cho bụi lá kép, hoa năm cánh, cỏ cong, cụm lá tán và cụm hoa tán. Cây thấp mọc từ gốc; cụm tán phân bố theo thể tích quanh nhánh, không dùng nguyên bụi thấp phóng lên ngọn. Bồn, chậu hiên và cây dùng cùng bộ mesh/vật liệu, nhánh phố cũ giữ bộ cũ. Chưa wind/LOD/texture gân lá hoặc chứng nhận FPS.

Khám phá tại chỗ: trà đình và gian nghề có điểm quan sát trước bàn, dùng chung panel đọc và thao tác Xem/F, đóng/Escape. Nội dung mô tả đồ vật và vai trò social của không gian, không mượn portrait/NPC hay mở chế tạo, nhận trà, buff/reward. Hai điểm là tùy chọn ngay khi vào sân, không thay tiến trình Keeper/Đá Luyện; đóng trước khi đọc xong không ghi đã xem. Đây là bước kết nối cảnh quan với tương tác, chưa thay Thanh Huyền hoặc sinh hoạt dân cư.
Góc quan sát được mở chủ động bằng Xem: camera nhìn bộ trà hoặc bàn nghề, panel đọc nằm cạnh trái ở desktop và dùng body/footer chung; đóng sẽ trả camera chơi. Hình học prop hiện còn đơn giản, cần tạo hình cả bộ trước khi coi đây là cảnh final.

Pass bộ prop sinh hoạt: giữ bố cục demo trà đình/gian nghề; bộ ấm đất nung có thân/nắp/quai/vòi thông miệng, bốn chén men xanh có lòng và đĩa, khay có viền. Tham khảo cấu tạo hiện vật [ấm tại The Met](https://www.metmuseum.org/art/collection/search/46027), không lấy ảnh làm runtime asset. Gian nghề phân biệt búa/đục/kìm và ê-tô có hai má, vít và tay vặn. `CityEverydayProps` dùng profile quay/sweep có thể chỉnh và batch vật liệu chung, không biến thành vật phẩm nhận được hoặc cơ chế chế tạo.
