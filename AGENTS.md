...
- UI shared component governance — owner lock 2026-09-13:
  ...
  - modal/dialog/card/tab/button/detail panel dùng base chung trong shared skin/helper trước khi tạo biến thể riêng. Không tạo helper skin song song kiểu `StyleModalDialog`, `BuildCardPanel`, `CreateDetailPanel` trong partial runtime; nếu cần biến thể thì thêm wrapper/base vào shared skin trước. Nếu hai UI/UX giống nhau mà cần khác hành vi, tách data/state/action, không copy nguyên layout/skin thành hệ mới.
