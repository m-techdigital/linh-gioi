...
- Character Hub dựng topology Skill, Tiềm năng và Linh thú đúng một lần từ shared base. Riêng Tiềm năng, một vector base phải sở hữu sẵn vòng ngoài, đường nối, core và toàn bộ khung tròn của năm node; button/node phía trên chỉ là interaction/data overlay trong suốt. Đổi class chỉ bind profile/data/icon/text/state vào các node có sẵn; không xóa panel, dựng lại vòng tròn/đường nối hoặc tạo layout riêng theo class. Tiềm năng và Skill là hai topology/component riêng, còn class chỉ cung cấp dữ liệu tương ứng.
