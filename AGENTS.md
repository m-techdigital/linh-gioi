...
- Scope hiện hành là hoàn thiện Map01A và các UI screen 2D theo design-first. Entry, Character Select, Chọn máy chủ và Đăng ký đã khóa; screen active duy nhất là `Quên mật khẩu`. Không resume class/pose/wardrobe/source, không chạy class Player/capture loop và không rollback class code.
