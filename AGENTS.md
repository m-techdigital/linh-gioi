...
- UI shared component governance — owner lock 2026-09-13:
  ...
  - Hành trang, Thông tin nhân vật và Rương đồ là các tab/flow riêng nhưng dùng chung inventory shell, shared tab/button skin và cùng item-detail component. Khi chọn món từ túi hoặc từ trang bị nhân vật, detail đồ hiện ở panel bên phải theo design đã chốt; không đảo vị trí detail giữa các tab.
