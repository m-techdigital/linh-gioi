...
- Character Hub dựng topology Skill, Tiềm năng và Linh thú đúng một lần từ shared base. Đổi class chỉ bind profile/data/icon/text/state vào các node có sẵn; không xóa panel, dựng lại vòng tròn/đường nối hoặc tạo layout riêng theo class. Tiềm năng và Skill là hai topology/component riêng, còn class chỉ cung cấp dữ liệu tương ứng.
